...
# kernel path: /tmp/torchinductor_sahanp/f3/cf3cepj6zayut7nqcw34oxmblfxqe75k6j6cqcgtllkt6g6q3mkd.py
...
# kernel path: /tmp/torchinductor_sahanp/rh/crhnqjtgyu3xpeekttyikuveharws7da3bfalxg33rp5jnjpfojj.py
...
# kernel path: /tmp/torchinductor_sahanp/p4/cp4htjmtk4wldz2valbije6ryr4lsy4gagdmm4dacq75tklqwnzl.py
...
# kernel path: /tmp/torchinductor_sahanp/6e/c6e4ptzjfyp6vjidjnrsjlqvpdti5bcs3oke2bgqcr3m3jpklc43.py
...
#   %full_default_2 : [num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([8, 1, 512, 512], False), kwargs = {dtype: torch.bool, layout: torch.strided, device: cuda:0, pin_memory: False})
...
# kernel path: /tmp/torchinductor_sahanp/gt/cgtjugmcg7manapfawfpiaqtk4xyg4wpultew3mt6ahmmyhclcid.py
...
# kernel path: /tmp/torchinductor_sahanp/6y/c6yqmgtpgjikwpjndcwee5xguky63znhm62vlbzy7sea5cndhj2b.py
...
# kernel path: /tmp/torchinductor_sahanp/2o/c2obv6a5tuxhdlu6e57j2gwq7hjxqadescbfla2v7myllbivpgmn.py
...
# kernel path: /tmp/torchinductor_sahanp/pq/cpq5bhewhxeoapx6fi4k25mua523rztzj3onfw75b2x7gjkyw4jy.py
...
# kernel path: /tmp/torchinductor_sahanp/b4/cb4feqqbjwhgzi33psrgo2fp3paf43km5s5pnf6i3k4tdco6r7z6.py
# Topologically Sorted Source Nodes: [hidden_states_124, hidden_states_125], Original ATen: [aten.gelu, aten.native_layer_norm]
# Source node to ATen node mapping:
#   hidden_states_124 => add_111, erf_12, mul_75, mul_76, mul_77
#   hidden_states_125 => add_112, add_113, mul_78, mul_79, rsqrt, sub_62, var_mean
# Graph fragment:
#   %mul_75 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_229, 0.5), kwargs = {})
#   %mul_76 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_229, 0.7071067811865476), kwargs = {})
#   %erf_12 : [num_users=1] = call_function[target=torch.ops.aten.erf.default](args = (%mul_76,), kwargs = {})
#   %add_111 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%erf_12, 1), kwargs = {})
#   %mul_77 : [num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_75, %add_111), kwargs = {})
#   %var_mean : [num_users=2] = call_function[target=torch.ops.aten.var_mean.correction](args = (%mul_77, [2]), kwargs = {correction: 0, keepdim: True})
#   %sub_62 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_77, %getitem_37), kwargs = {})
#   %add_112 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%getitem_36, 1e-07), kwargs = {})
#   %rsqrt : [num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_112,), kwargs = {})
#   %mul_78 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_62, %rsqrt), kwargs = {})
#   %mul_79 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_78, %arg164_1), kwargs = {})
#   %add_113 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_79, %arg165_1), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/lo/clobqhyh6obw7ejr2wd3gni6svvsvqguuon377bfodruh6mz37fx.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%permute_109, %full_default_51], 1), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/54/c54snf35wlajdjrmrbjkqoa4cxsn3datyqjebzpns6a45tmy7yho.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_1 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%arg166_1, %full_default_52],), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/xb/cxbgthwk4fjdq5e7lq77suwkrmrab63gt4ebcxdapzkiofcoga6k.py
...
# Graph fragment:
#   %amax_12 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%view_232, [1], True), kwargs = {})
#   %sub_63 : [num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_232, %amax_12), kwargs = {})
#   %exp_12 : [num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_63,), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/oq/coqlnh2s3razrnscees5sdg6gyeavxf525i7qr3zk3h6s7svar2r.py
...
# Graph fragment:
#   %ne_1 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%view_233, -100), kwargs = {})
...
#   %ne_2 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%view_233, -100), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg166_1, (50265, ), (1, ))
    assert_size_stride(arg167_1, (8, 512), (512, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf2 = empty_strided_cuda((8, 512, 768), (393216, 768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [inputs_embeds, position_embeddings, embeddings, mean, sub_1, sub, pow_1, variance, add, sqrt, hidden_states_1, mul, embeddings_1], Original ATen: [aten.embedding, aten.add, aten.mean, aten.sub, aten.pow, aten.sqrt, aten.div, aten.mul]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_div_embedding_mean_mul_pow_sqrt_sub_0.run(arg0_1, arg2_1, arg1_1, arg3_1, arg4_1, arg5_1, buf2, 4096, 768, grid=grid(4096), stream=stream0)
        del arg0_1
        del arg1_1
        del arg3_1
        del arg4_1
        del arg5_1
        buf3 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [qp], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf2, (4096, 768), (768, 1), 0), reinterpret_tensor(arg6_1, (768, 2304), (1, 768), 0), out=buf3)
        del arg6_1
        buf4 = empty_strided_cuda((8, 12, 512, 64), (393216, 32768, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [query_layer_1, scale, query_layer_2, attention_scores], Original ATen: [aten.add, aten.sqrt, aten.div, aten.clone]
        triton_poi_fused_add_clone_div_sqrt_1.run(buf3, arg7_1, buf4, 3145728, grid=grid(3145728), stream=stream0)
        del arg7_1
        buf5 = empty_strided_cuda((8, 12, 64, 512), (393216, 32768, 512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attention_scores], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf3, buf5, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf6 = empty_strided_cuda((96, 512, 512), (262144, 512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attention_scores], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf4, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf5, (96, 64, 512), (32768, 512, 1), 0), out=buf6)
        buf9 = empty_strided_cuda((8, 12, 512, 512), (3145728, 262144, 512, 1), torch.float32)
        # Topologically Sorted Source Nodes: [masked_fill_, rmask, tensor_1, output, output_1], Original ATen: [aten.masked_fill, aten.bitwise_not, aten.lift_fresh, aten._softmax]
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf6, buf9, 49152, 512, grid=grid(49152), stream=stream0)
        buf10 = reinterpret_tensor(buf5, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf5  # reuse
        # Topologically Sorted Source Nodes: [value_layer_1, context_layer], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf3, arg8_1, buf10, 3145728, grid=grid(3145728), stream=stream0)
        del arg8_1
        buf11 = reinterpret_tensor(buf4, (96, 512, 64), (32768, 64, 1), 0); del buf4  # reuse
        # Topologically Sorted Source Nodes: [context_layer], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf9, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf10, (96, 512, 64), (32768, 64, 1), 0), out=buf11)
        buf12 = reinterpret_tensor(buf10, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf10  # reuse
        # Topologically Sorted Source Nodes: [context_layer_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf11, buf12, 3145728, grid=grid(3145728), stream=stream0)
        buf13 = reinterpret_tensor(buf11, (4096, 768), (768, 1), 0); del buf11  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf12, (4096, 768), (768, 1), 0), reinterpret_tensor(arg9_1, (768, 768), (1, 768), 0), out=buf13)
        del arg9_1
        buf16 = reinterpret_tensor(buf12, (8, 512, 768), (393216, 768, 1), 0); del buf12  # reuse
        # Topologically Sorted Source Nodes: [add_4, mean_3, sub_3, sub_2, pow_2, variance_1, add_5, sqrt_2, hidden_states_5, mul_4, y_1], Original ATen: [aten.add, aten.mean, aten.sub, aten.pow, aten.sqrt, aten.div, aten.mul]
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf13, arg10_1, buf2, arg11_1, arg12_1, buf16, 4096, 768, grid=grid(4096), stream=stream0)
        del arg10_1
        del arg11_1
        del arg12_1
        buf17 = empty_strided_cuda((4096, 3072), (3072, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf16, (4096, 768), (768, 1), 0), reinterpret_tensor(arg13_1, (768, 3072), (1, 768), 0), out=buf17)
        del arg13_1
        buf18 = reinterpret_tensor(buf17, (8, 512, 3072), (1572864, 3072, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_8], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf18, arg14_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg14_1
        buf19 = reinterpret_tensor(buf2, (4096, 768), (768, 1), 0); del buf2  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf18, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg15_1, (3072, 768), (1, 3072), 0), out=buf19)
        del arg15_1
        buf22 = reinterpret_tensor(buf13, (8, 512, 768), (393216, 768, 1), 0); del buf13  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf19, arg16_1, buf16, arg17_1, arg18_1, buf22, 4096, 768, grid=grid(4096), stream=stream0)
        del arg16_1
        del arg17_1
        del arg18_1
        buf23 = buf3; del buf3  # reuse
        # Topologically Sorted Source Nodes: [qp_1], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf22, (4096, 768), (768, 1), 0), reinterpret_tensor(arg19_1, (768, 2304), (1, 768), 0), out=buf23)
        del arg19_1
        buf24 = reinterpret_tensor(buf19, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf19  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf23, arg20_1, buf24, 3145728, grid=grid(3145728), stream=stream0)
        del arg20_1
        buf25 = reinterpret_tensor(buf16, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf16  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_1], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf23, buf25, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf26 = reinterpret_tensor(buf9, (96, 512, 512), (262144, 512, 1), 0); del buf9  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_1], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf24, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf25, (96, 64, 512), (32768, 512, 1), 0), out=buf26)
        buf29 = reinterpret_tensor(buf6, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf6  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf26, buf29, 49152, 512, grid=grid(49152), stream=stream0)
        buf30 = reinterpret_tensor(buf25, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [value_layer_3, context_layer_3], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf23, arg21_1, buf30, 3145728, grid=grid(3145728), stream=stream0)
        del arg21_1
        buf31 = reinterpret_tensor(buf24, (96, 512, 64), (32768, 64, 1), 0); del buf24  # reuse
        # Topologically Sorted Source Nodes: [context_layer_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf29, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf30, (96, 512, 64), (32768, 64, 1), 0), out=buf31)
        buf32 = reinterpret_tensor(buf30, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf30  # reuse
        # Topologically Sorted Source Nodes: [context_layer_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf31, buf32, 3145728, grid=grid(3145728), stream=stream0)
        buf33 = reinterpret_tensor(buf31, (4096, 768), (768, 1), 0); del buf31  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf32, (4096, 768), (768, 1), 0), reinterpret_tensor(arg22_1, (768, 768), (1, 768), 0), out=buf33)
        del arg22_1
        buf36 = reinterpret_tensor(buf32, (8, 512, 768), (393216, 768, 1), 0); del buf32  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf33, arg23_1, buf22, arg24_1, arg25_1, buf36, 4096, 768, grid=grid(4096), stream=stream0)
        del arg23_1
        del arg24_1
        del arg25_1
        buf37 = reinterpret_tensor(buf18, (4096, 3072), (3072, 1), 0); del buf18  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf36, (4096, 768), (768, 1), 0), reinterpret_tensor(arg26_1, (768, 3072), (1, 768), 0), out=buf37)
        del arg26_1
        buf38 = reinterpret_tensor(buf37, (8, 512, 3072), (1572864, 3072, 1), 0); del buf37  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_18], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf38, arg27_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg27_1
        buf39 = buf33; del buf33  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf38, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg28_1, (3072, 768), (1, 3072), 0), out=buf39)
        del arg28_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf39, arg29_1, buf36, arg30_1, arg31_1, buf42, 4096, 768, grid=grid(4096), stream=stream0)
        del arg29_1
        del arg30_1
        del arg31_1
        buf43 = buf23; del buf23  # reuse
        # Topologically Sorted Source Nodes: [qp_2], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf42, (4096, 768), (768, 1), 0), reinterpret_tensor(arg32_1, (768, 2304), (1, 768), 0), out=buf43)
        del arg32_1
        buf44 = reinterpret_tensor(buf39, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf39  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf43, arg33_1, buf44, 3145728, grid=grid(3145728), stream=stream0)
        del arg33_1
        buf45 = reinterpret_tensor(buf36, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf43, buf45, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf46 = reinterpret_tensor(buf29, (96, 512, 512), (262144, 512, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_2], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf44, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf45, (96, 64, 512), (32768, 512, 1), 0), out=buf46)
        buf49 = reinterpret_tensor(buf26, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf26  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf46, buf49, 49152, 512, grid=grid(49152), stream=stream0)
        buf50 = reinterpret_tensor(buf45, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf45  # reuse
        # Topologically Sorted Source Nodes: [value_layer_5, context_layer_6], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf43, arg34_1, buf50, 3145728, grid=grid(3145728), stream=stream0)
        del arg34_1
        buf51 = reinterpret_tensor(buf44, (96, 512, 64), (32768, 64, 1), 0); del buf44  # reuse
        # Topologically Sorted Source Nodes: [context_layer_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf49, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf50, (96, 512, 64), (32768, 64, 1), 0), out=buf51)
        buf52 = reinterpret_tensor(buf50, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [context_layer_7], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf51, buf52, 3145728, grid=grid(3145728), stream=stream0)
        buf53 = reinterpret_tensor(buf51, (4096, 768), (768, 1), 0); del buf51  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf52, (4096, 768), (768, 1), 0), reinterpret_tensor(arg35_1, (768, 768), (1, 768), 0), out=buf53)
        del arg35_1
        buf56 = reinterpret_tensor(buf52, (8, 512, 768), (393216, 768, 1), 0); del buf52  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf53, arg36_1, buf42, arg37_1, arg38_1, buf56, 4096, 768, grid=grid(4096), stream=stream0)
        del arg36_1
        del arg37_1
        del arg38_1
        buf57 = reinterpret_tensor(buf38, (4096, 3072), (3072, 1), 0); del buf38  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf56, (4096, 768), (768, 1), 0), reinterpret_tensor(arg39_1, (768, 3072), (1, 768), 0), out=buf57)
        del arg39_1
        buf58 = reinterpret_tensor(buf57, (8, 512, 3072), (1572864, 3072, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_28], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf58, arg40_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg40_1
        buf59 = buf53; del buf53  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf58, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg41_1, (3072, 768), (1, 3072), 0), out=buf59)
        del arg41_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf59, arg42_1, buf56, arg43_1, arg44_1, buf62, 4096, 768, grid=grid(4096), stream=stream0)
        del arg42_1
        del arg43_1
        del arg44_1
        buf63 = buf43; del buf43  # reuse
        # Topologically Sorted Source Nodes: [qp_3], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf62, (4096, 768), (768, 1), 0), reinterpret_tensor(arg45_1, (768, 2304), (1, 768), 0), out=buf63)
        del arg45_1
        buf64 = reinterpret_tensor(buf59, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf59  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf63, arg46_1, buf64, 3145728, grid=grid(3145728), stream=stream0)
        del arg46_1
        buf65 = reinterpret_tensor(buf56, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf63, buf65, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf66 = reinterpret_tensor(buf49, (96, 512, 512), (262144, 512, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_3], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf64, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf65, (96, 64, 512), (32768, 512, 1), 0), out=buf66)
        buf69 = reinterpret_tensor(buf46, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf46  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf66, buf69, 49152, 512, grid=grid(49152), stream=stream0)
        buf70 = reinterpret_tensor(buf65, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [value_layer_7, context_layer_9], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf63, arg47_1, buf70, 3145728, grid=grid(3145728), stream=stream0)
        del arg47_1
        buf71 = reinterpret_tensor(buf64, (96, 512, 64), (32768, 64, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [context_layer_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf69, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf70, (96, 512, 64), (32768, 64, 1), 0), out=buf71)
        buf72 = reinterpret_tensor(buf70, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf70  # reuse
        # Topologically Sorted Source Nodes: [context_layer_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf71, buf72, 3145728, grid=grid(3145728), stream=stream0)
        buf73 = reinterpret_tensor(buf71, (4096, 768), (768, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf72, (4096, 768), (768, 1), 0), reinterpret_tensor(arg48_1, (768, 768), (1, 768), 0), out=buf73)
        del arg48_1
        buf76 = reinterpret_tensor(buf72, (8, 512, 768), (393216, 768, 1), 0); del buf72  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf73, arg49_1, buf62, arg50_1, arg51_1, buf76, 4096, 768, grid=grid(4096), stream=stream0)
        del arg49_1
        del arg50_1
        del arg51_1
        buf77 = reinterpret_tensor(buf58, (4096, 3072), (3072, 1), 0); del buf58  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (4096, 768), (768, 1), 0), reinterpret_tensor(arg52_1, (768, 3072), (1, 768), 0), out=buf77)
        del arg52_1
        buf78 = reinterpret_tensor(buf77, (8, 512, 3072), (1572864, 3072, 1), 0); del buf77  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_38], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf78, arg53_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg53_1
        buf79 = buf73; del buf73  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg54_1, (3072, 768), (1, 3072), 0), out=buf79)
        del arg54_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf79, arg55_1, buf76, arg56_1, arg57_1, buf82, 4096, 768, grid=grid(4096), stream=stream0)
        del arg55_1
        del arg56_1
        del arg57_1
        buf83 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [qp_4], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf82, (4096, 768), (768, 1), 0), reinterpret_tensor(arg58_1, (768, 2304), (1, 768), 0), out=buf83)
        del arg58_1
        buf84 = reinterpret_tensor(buf79, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf79  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf83, arg59_1, buf84, 3145728, grid=grid(3145728), stream=stream0)
        del arg59_1
        buf85 = reinterpret_tensor(buf76, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf83, buf85, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf86 = reinterpret_tensor(buf69, (96, 512, 512), (262144, 512, 1), 0); del buf69  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf84, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf85, (96, 64, 512), (32768, 512, 1), 0), out=buf86)
        buf89 = reinterpret_tensor(buf66, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf66  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf86, buf89, 49152, 512, grid=grid(49152), stream=stream0)
        buf90 = reinterpret_tensor(buf85, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf85  # reuse
        # Topologically Sorted Source Nodes: [value_layer_9, context_layer_12], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf83, arg60_1, buf90, 3145728, grid=grid(3145728), stream=stream0)
        del arg60_1
        buf91 = reinterpret_tensor(buf84, (96, 512, 64), (32768, 64, 1), 0); del buf84  # reuse
        # Topologically Sorted Source Nodes: [context_layer_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf89, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf90, (96, 512, 64), (32768, 64, 1), 0), out=buf91)
        buf92 = reinterpret_tensor(buf90, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf90  # reuse
        # Topologically Sorted Source Nodes: [context_layer_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf91, buf92, 3145728, grid=grid(3145728), stream=stream0)
        buf93 = reinterpret_tensor(buf91, (4096, 768), (768, 1), 0); del buf91  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf92, (4096, 768), (768, 1), 0), reinterpret_tensor(arg61_1, (768, 768), (1, 768), 0), out=buf93)
        del arg61_1
        buf96 = reinterpret_tensor(buf92, (8, 512, 768), (393216, 768, 1), 0); del buf92  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf93, arg62_1, buf82, arg63_1, arg64_1, buf96, 4096, 768, grid=grid(4096), stream=stream0)
        del arg62_1
        del arg63_1
        del arg64_1
        buf97 = reinterpret_tensor(buf78, (4096, 3072), (3072, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (4096, 768), (768, 1), 0), reinterpret_tensor(arg65_1, (768, 3072), (1, 768), 0), out=buf97)
        del arg65_1
        buf98 = reinterpret_tensor(buf97, (8, 512, 3072), (1572864, 3072, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_48], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf98, arg66_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg66_1
        buf99 = buf93; del buf93  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg67_1, (3072, 768), (1, 3072), 0), out=buf99)
        del arg67_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf99, arg68_1, buf96, arg69_1, arg70_1, buf102, 4096, 768, grid=grid(4096), stream=stream0)
        del arg68_1
        del arg69_1
        del arg70_1
        buf103 = buf83; del buf83  # reuse
        # Topologically Sorted Source Nodes: [qp_5], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf102, (4096, 768), (768, 1), 0), reinterpret_tensor(arg71_1, (768, 2304), (1, 768), 0), out=buf103)
        del arg71_1
        buf104 = reinterpret_tensor(buf99, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf99  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf103, arg72_1, buf104, 3145728, grid=grid(3145728), stream=stream0)
        del arg72_1
        buf105 = reinterpret_tensor(buf96, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf103, buf105, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf106 = reinterpret_tensor(buf89, (96, 512, 512), (262144, 512, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf104, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf105, (96, 64, 512), (32768, 512, 1), 0), out=buf106)
        buf109 = reinterpret_tensor(buf86, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf86  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf106, buf109, 49152, 512, grid=grid(49152), stream=stream0)
        buf110 = reinterpret_tensor(buf105, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [value_layer_11, context_layer_15], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf103, arg73_1, buf110, 3145728, grid=grid(3145728), stream=stream0)
        del arg73_1
        buf111 = reinterpret_tensor(buf104, (96, 512, 64), (32768, 64, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [context_layer_15], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf109, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf110, (96, 512, 64), (32768, 64, 1), 0), out=buf111)
        buf112 = reinterpret_tensor(buf110, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf110  # reuse
        # Topologically Sorted Source Nodes: [context_layer_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf111, buf112, 3145728, grid=grid(3145728), stream=stream0)
        buf113 = reinterpret_tensor(buf111, (4096, 768), (768, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (4096, 768), (768, 1), 0), reinterpret_tensor(arg74_1, (768, 768), (1, 768), 0), out=buf113)
        del arg74_1
        buf116 = reinterpret_tensor(buf112, (8, 512, 768), (393216, 768, 1), 0); del buf112  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf113, arg75_1, buf102, arg76_1, arg77_1, buf116, 4096, 768, grid=grid(4096), stream=stream0)
        del arg75_1
        del arg76_1
        del arg77_1
        buf117 = reinterpret_tensor(buf98, (4096, 3072), (3072, 1), 0); del buf98  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (4096, 768), (768, 1), 0), reinterpret_tensor(arg78_1, (768, 3072), (1, 768), 0), out=buf117)
        del arg78_1
        buf118 = reinterpret_tensor(buf117, (8, 512, 3072), (1572864, 3072, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_58], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf118, arg79_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg79_1
        buf119 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg80_1, (3072, 768), (1, 3072), 0), out=buf119)
        del arg80_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf119, arg81_1, buf116, arg82_1, arg83_1, buf122, 4096, 768, grid=grid(4096), stream=stream0)
        del arg81_1
        del arg82_1
        del arg83_1
        buf123 = buf103; del buf103  # reuse
        # Topologically Sorted Source Nodes: [qp_6], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf122, (4096, 768), (768, 1), 0), reinterpret_tensor(arg84_1, (768, 2304), (1, 768), 0), out=buf123)
        del arg84_1
        buf124 = reinterpret_tensor(buf119, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf119  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf123, arg85_1, buf124, 3145728, grid=grid(3145728), stream=stream0)
        del arg85_1
        buf125 = reinterpret_tensor(buf116, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf123, buf125, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf126 = reinterpret_tensor(buf109, (96, 512, 512), (262144, 512, 1), 0); del buf109  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_6], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf124, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf125, (96, 64, 512), (32768, 512, 1), 0), out=buf126)
        buf129 = reinterpret_tensor(buf106, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf106  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf126, buf129, 49152, 512, grid=grid(49152), stream=stream0)
        buf130 = reinterpret_tensor(buf125, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf125  # reuse
        # Topologically Sorted Source Nodes: [value_layer_13, context_layer_18], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf123, arg86_1, buf130, 3145728, grid=grid(3145728), stream=stream0)
        del arg86_1
        buf131 = reinterpret_tensor(buf124, (96, 512, 64), (32768, 64, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [context_layer_18], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf129, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf130, (96, 512, 64), (32768, 64, 1), 0), out=buf131)
        buf132 = reinterpret_tensor(buf130, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [context_layer_19], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf131, buf132, 3145728, grid=grid(3145728), stream=stream0)
        buf133 = reinterpret_tensor(buf131, (4096, 768), (768, 1), 0); del buf131  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf132, (4096, 768), (768, 1), 0), reinterpret_tensor(arg87_1, (768, 768), (1, 768), 0), out=buf133)
        del arg87_1
        buf136 = reinterpret_tensor(buf132, (8, 512, 768), (393216, 768, 1), 0); del buf132  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf133, arg88_1, buf122, arg89_1, arg90_1, buf136, 4096, 768, grid=grid(4096), stream=stream0)
        del arg88_1
        del arg89_1
        del arg90_1
        buf137 = reinterpret_tensor(buf118, (4096, 3072), (3072, 1), 0); del buf118  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (4096, 768), (768, 1), 0), reinterpret_tensor(arg91_1, (768, 3072), (1, 768), 0), out=buf137)
        del arg91_1
        buf138 = reinterpret_tensor(buf137, (8, 512, 3072), (1572864, 3072, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_68], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf138, arg92_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg92_1
        buf139 = buf133; del buf133  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg93_1, (3072, 768), (1, 3072), 0), out=buf139)
        del arg93_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf139, arg94_1, buf136, arg95_1, arg96_1, buf142, 4096, 768, grid=grid(4096), stream=stream0)
        del arg94_1
        del arg95_1
        del arg96_1
        buf143 = buf123; del buf123  # reuse
        # Topologically Sorted Source Nodes: [qp_7], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf142, (4096, 768), (768, 1), 0), reinterpret_tensor(arg97_1, (768, 2304), (1, 768), 0), out=buf143)
        del arg97_1
        buf144 = reinterpret_tensor(buf139, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf139  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf143, arg98_1, buf144, 3145728, grid=grid(3145728), stream=stream0)
        del arg98_1
        buf145 = reinterpret_tensor(buf136, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_7], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf143, buf145, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf146 = reinterpret_tensor(buf129, (96, 512, 512), (262144, 512, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_7], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf144, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf145, (96, 64, 512), (32768, 512, 1), 0), out=buf146)
        buf149 = reinterpret_tensor(buf126, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf126  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf146, buf149, 49152, 512, grid=grid(49152), stream=stream0)
        buf150 = reinterpret_tensor(buf145, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf145  # reuse
        # Topologically Sorted Source Nodes: [value_layer_15, context_layer_21], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf143, arg99_1, buf150, 3145728, grid=grid(3145728), stream=stream0)
        del arg99_1
        buf151 = reinterpret_tensor(buf144, (96, 512, 64), (32768, 64, 1), 0); del buf144  # reuse
        # Topologically Sorted Source Nodes: [context_layer_21], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf149, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf150, (96, 512, 64), (32768, 64, 1), 0), out=buf151)
        buf152 = reinterpret_tensor(buf150, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf150  # reuse
        # Topologically Sorted Source Nodes: [context_layer_22], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf151, buf152, 3145728, grid=grid(3145728), stream=stream0)
        buf153 = reinterpret_tensor(buf151, (4096, 768), (768, 1), 0); del buf151  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf152, (4096, 768), (768, 1), 0), reinterpret_tensor(arg100_1, (768, 768), (1, 768), 0), out=buf153)
        del arg100_1
        buf156 = reinterpret_tensor(buf152, (8, 512, 768), (393216, 768, 1), 0); del buf152  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf153, arg101_1, buf142, arg102_1, arg103_1, buf156, 4096, 768, grid=grid(4096), stream=stream0)
        del arg101_1
        del arg102_1
        del arg103_1
        buf157 = reinterpret_tensor(buf138, (4096, 3072), (3072, 1), 0); del buf138  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (4096, 768), (768, 1), 0), reinterpret_tensor(arg104_1, (768, 3072), (1, 768), 0), out=buf157)
        del arg104_1
        buf158 = reinterpret_tensor(buf157, (8, 512, 3072), (1572864, 3072, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_78], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf158, arg105_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg105_1
        buf159 = buf153; del buf153  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg106_1, (3072, 768), (1, 3072), 0), out=buf159)
        del arg106_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf159, arg107_1, buf156, arg108_1, arg109_1, buf162, 4096, 768, grid=grid(4096), stream=stream0)
        del arg107_1
        del arg108_1
        del arg109_1
        buf163 = buf143; del buf143  # reuse
        # Topologically Sorted Source Nodes: [qp_8], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf162, (4096, 768), (768, 1), 0), reinterpret_tensor(arg110_1, (768, 2304), (1, 768), 0), out=buf163)
        del arg110_1
        buf164 = reinterpret_tensor(buf159, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf159  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf163, arg111_1, buf164, 3145728, grid=grid(3145728), stream=stream0)
        del arg111_1
        buf165 = reinterpret_tensor(buf156, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf163, buf165, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf166 = reinterpret_tensor(buf149, (96, 512, 512), (262144, 512, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf164, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf165, (96, 64, 512), (32768, 512, 1), 0), out=buf166)
        buf169 = reinterpret_tensor(buf146, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf146  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf166, buf169, 49152, 512, grid=grid(49152), stream=stream0)
        buf170 = reinterpret_tensor(buf165, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf165  # reuse
        # Topologically Sorted Source Nodes: [value_layer_17, context_layer_24], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf163, arg112_1, buf170, 3145728, grid=grid(3145728), stream=stream0)
        del arg112_1
        buf171 = reinterpret_tensor(buf164, (96, 512, 64), (32768, 64, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [context_layer_24], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf169, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf170, (96, 512, 64), (32768, 64, 1), 0), out=buf171)
        buf172 = reinterpret_tensor(buf170, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf170  # reuse
        # Topologically Sorted Source Nodes: [context_layer_25], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf171, buf172, 3145728, grid=grid(3145728), stream=stream0)
        buf173 = reinterpret_tensor(buf171, (4096, 768), (768, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf172, (4096, 768), (768, 1), 0), reinterpret_tensor(arg113_1, (768, 768), (1, 768), 0), out=buf173)
        del arg113_1
        buf176 = reinterpret_tensor(buf172, (8, 512, 768), (393216, 768, 1), 0); del buf172  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf173, arg114_1, buf162, arg115_1, arg116_1, buf176, 4096, 768, grid=grid(4096), stream=stream0)
        del arg114_1
        del arg115_1
        del arg116_1
        buf177 = reinterpret_tensor(buf158, (4096, 3072), (3072, 1), 0); del buf158  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf176, (4096, 768), (768, 1), 0), reinterpret_tensor(arg117_1, (768, 3072), (1, 768), 0), out=buf177)
        del arg117_1
        buf178 = reinterpret_tensor(buf177, (8, 512, 3072), (1572864, 3072, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_88], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf178, arg118_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg118_1
        buf179 = buf173; del buf173  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf178, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg119_1, (3072, 768), (1, 3072), 0), out=buf179)
        del arg119_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf179, arg120_1, buf176, arg121_1, arg122_1, buf182, 4096, 768, grid=grid(4096), stream=stream0)
        del arg120_1
        del arg121_1
        del arg122_1
        buf183 = buf163; del buf163  # reuse
        # Topologically Sorted Source Nodes: [qp_9], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf182, (4096, 768), (768, 1), 0), reinterpret_tensor(arg123_1, (768, 2304), (1, 768), 0), out=buf183)
        del arg123_1
        buf184 = reinterpret_tensor(buf179, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf179  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf183, arg124_1, buf184, 3145728, grid=grid(3145728), stream=stream0)
        del arg124_1
        buf185 = reinterpret_tensor(buf176, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_9], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf183, buf185, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf186 = reinterpret_tensor(buf169, (96, 512, 512), (262144, 512, 1), 0); del buf169  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_9], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf184, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf185, (96, 64, 512), (32768, 512, 1), 0), out=buf186)
        buf189 = reinterpret_tensor(buf166, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf166  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf186, buf189, 49152, 512, grid=grid(49152), stream=stream0)
        buf190 = reinterpret_tensor(buf185, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf185  # reuse
        # Topologically Sorted Source Nodes: [value_layer_19, context_layer_27], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf183, arg125_1, buf190, 3145728, grid=grid(3145728), stream=stream0)
        del arg125_1
        buf191 = reinterpret_tensor(buf184, (96, 512, 64), (32768, 64, 1), 0); del buf184  # reuse
        # Topologically Sorted Source Nodes: [context_layer_27], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf189, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf190, (96, 512, 64), (32768, 64, 1), 0), out=buf191)
        buf192 = reinterpret_tensor(buf190, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf190  # reuse
        # Topologically Sorted Source Nodes: [context_layer_28], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf191, buf192, 3145728, grid=grid(3145728), stream=stream0)
        buf193 = reinterpret_tensor(buf191, (4096, 768), (768, 1), 0); del buf191  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf192, (4096, 768), (768, 1), 0), reinterpret_tensor(arg126_1, (768, 768), (1, 768), 0), out=buf193)
        del arg126_1
        buf196 = reinterpret_tensor(buf192, (8, 512, 768), (393216, 768, 1), 0); del buf192  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf193, arg127_1, buf182, arg128_1, arg129_1, buf196, 4096, 768, grid=grid(4096), stream=stream0)
        del arg127_1
        del arg128_1
        del arg129_1
        buf197 = reinterpret_tensor(buf178, (4096, 3072), (3072, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf196, (4096, 768), (768, 1), 0), reinterpret_tensor(arg130_1, (768, 3072), (1, 768), 0), out=buf197)
        del arg130_1
        buf198 = reinterpret_tensor(buf197, (8, 512, 3072), (1572864, 3072, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_98], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf198, arg131_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg131_1
        buf199 = buf193; del buf193  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf198, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg132_1, (3072, 768), (1, 3072), 0), out=buf199)
        del arg132_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf199, arg133_1, buf196, arg134_1, arg135_1, buf202, 4096, 768, grid=grid(4096), stream=stream0)
        del arg133_1
        del arg134_1
        del arg135_1
        buf203 = buf183; del buf183  # reuse
        # Topologically Sorted Source Nodes: [qp_10], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf202, (4096, 768), (768, 1), 0), reinterpret_tensor(arg136_1, (768, 2304), (1, 768), 0), out=buf203)
        del arg136_1
        buf204 = reinterpret_tensor(buf199, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf199  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf203, arg137_1, buf204, 3145728, grid=grid(3145728), stream=stream0)
        del arg137_1
        buf205 = reinterpret_tensor(buf196, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf203, buf205, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf206 = reinterpret_tensor(buf189, (96, 512, 512), (262144, 512, 1), 0); del buf189  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_10], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf204, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf205, (96, 64, 512), (32768, 512, 1), 0), out=buf206)
        buf209 = reinterpret_tensor(buf186, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf186  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf206, buf209, 49152, 512, grid=grid(49152), stream=stream0)
        buf210 = reinterpret_tensor(buf205, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [value_layer_21, context_layer_30], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf203, arg138_1, buf210, 3145728, grid=grid(3145728), stream=stream0)
        del arg138_1
        buf211 = reinterpret_tensor(buf204, (96, 512, 64), (32768, 64, 1), 0); del buf204  # reuse
        # Topologically Sorted Source Nodes: [context_layer_30], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf209, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf210, (96, 512, 64), (32768, 64, 1), 0), out=buf211)
        buf212 = reinterpret_tensor(buf210, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf210  # reuse
        # Topologically Sorted Source Nodes: [context_layer_31], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf211, buf212, 3145728, grid=grid(3145728), stream=stream0)
        buf213 = reinterpret_tensor(buf211, (4096, 768), (768, 1), 0); del buf211  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf212, (4096, 768), (768, 1), 0), reinterpret_tensor(arg139_1, (768, 768), (1, 768), 0), out=buf213)
        del arg139_1
        buf216 = reinterpret_tensor(buf212, (8, 512, 768), (393216, 768, 1), 0); del buf212  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf213, arg140_1, buf202, arg141_1, arg142_1, buf216, 4096, 768, grid=grid(4096), stream=stream0)
        del arg140_1
        del arg141_1
        del arg142_1
        buf217 = reinterpret_tensor(buf198, (4096, 3072), (3072, 1), 0); del buf198  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf216, (4096, 768), (768, 1), 0), reinterpret_tensor(arg143_1, (768, 3072), (1, 768), 0), out=buf217)
        del arg143_1
        buf218 = reinterpret_tensor(buf217, (8, 512, 3072), (1572864, 3072, 1), 0); del buf217  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_108], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf218, arg144_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg144_1
        buf219 = buf213; del buf213  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf218, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg145_1, (3072, 768), (1, 3072), 0), out=buf219)
        del arg145_1
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf219, arg146_1, buf216, arg147_1, arg148_1, buf222, 4096, 768, grid=grid(4096), stream=stream0)
        del arg146_1
        del arg147_1
        del arg148_1
        buf223 = buf203; del buf203  # reuse
        # Topologically Sorted Source Nodes: [qp_11], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf222, (4096, 768), (768, 1), 0), reinterpret_tensor(arg149_1, (768, 2304), (1, 768), 0), out=buf223)
        del arg149_1
        buf224 = reinterpret_tensor(buf219, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf219  # reuse
        ...
        triton_poi_fused_add_clone_div_sqrt_1.run(buf223, arg150_1, buf224, 3145728, grid=grid(3145728), stream=stream0)
        del arg150_1
        buf225 = reinterpret_tensor(buf216, (8, 12, 64, 512), (393216, 32768, 512, 1), 0); del buf216  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_11], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf223, buf225, 6144, 512, grid=grid(6144, 512), stream=stream0)
        buf226 = reinterpret_tensor(buf209, (96, 512, 512), (262144, 512, 1), 0); del buf209  # reuse
        # Topologically Sorted Source Nodes: [attention_scores_11], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf224, (96, 512, 64), (32768, 64, 1), 0), reinterpret_tensor(buf225, (96, 64, 512), (32768, 512, 1), 0), out=buf226)
        buf229 = reinterpret_tensor(buf206, (8, 12, 512, 512), (3145728, 262144, 512, 1), 0); del buf206  # reuse
        ...
        triton_per_fused__softmax_bitwise_not_lift_fresh_masked_fill_3.run(buf226, buf229, 49152, 512, grid=grid(49152), stream=stream0)
        del buf226
        buf230 = reinterpret_tensor(buf225, (8, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf225  # reuse
        # Topologically Sorted Source Nodes: [value_layer_23, context_layer_33], Original ATen: [aten.add, aten.clone]
        triton_poi_fused_add_clone_4.run(buf223, arg151_1, buf230, 3145728, grid=grid(3145728), stream=stream0)
        del arg151_1
        del buf223
        buf231 = reinterpret_tensor(buf224, (96, 512, 64), (32768, 64, 1), 0); del buf224  # reuse
        # Topologically Sorted Source Nodes: [context_layer_33], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf229, (96, 512, 512), (262144, 512, 1), 0), reinterpret_tensor(buf230, (96, 512, 64), (32768, 64, 1), 0), out=buf231)
        del buf229
        buf232 = reinterpret_tensor(buf230, (8, 512, 12, 64), (393216, 768, 64, 1), 0); del buf230  # reuse
        # Topologically Sorted Source Nodes: [context_layer_34], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf231, buf232, 3145728, grid=grid(3145728), stream=stream0)
        buf233 = reinterpret_tensor(buf231, (4096, 768), (768, 1), 0); del buf231  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf232, (4096, 768), (768, 1), 0), reinterpret_tensor(arg152_1, (768, 768), (1, 768), 0), out=buf233)
        del arg152_1
        buf236 = reinterpret_tensor(buf232, (8, 512, 768), (393216, 768, 1), 0); del buf232  # reuse
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf233, arg153_1, buf222, arg154_1, arg155_1, buf236, 4096, 768, grid=grid(4096), stream=stream0)
        del arg153_1
        del arg154_1
        del arg155_1
        buf237 = reinterpret_tensor(buf218, (4096, 3072), (3072, 1), 0); del buf218  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf236, (4096, 768), (768, 1), 0), reinterpret_tensor(arg156_1, (768, 3072), (1, 768), 0), out=buf237)
        del arg156_1
        buf238 = reinterpret_tensor(buf237, (8, 512, 3072), (1572864, 3072, 1), 0); del buf237  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_118], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_7.run(buf238, arg157_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg157_1
        buf239 = buf233; del buf233  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf238, (4096, 3072), (3072, 1), 0), reinterpret_tensor(arg158_1, (3072, 768), (1, 3072), 0), out=buf239)
        del arg158_1
        del buf238
        ...
        triton_per_fused_add_div_mean_mul_pow_sqrt_sub_6.run(buf239, arg159_1, buf236, arg160_1, arg161_1, buf242, 4096, 768, grid=grid(4096), stream=stream0)
        del arg159_1
        del arg160_1
        del arg161_1
        del buf236
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf242, (4096, 768), (768, 1), 0), reinterpret_tensor(arg162_1, (768, 768), (1, 768), 0), out=buf243)
        del arg162_1
        buf247 = buf242; del buf242  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_124, hidden_states_125], Original ATen: [aten.gelu, aten.native_layer_norm]
        triton_per_fused_gelu_native_layer_norm_8.run(buf243, arg163_1, arg164_1, arg165_1, buf247, 4096, 768, grid=grid(4096), stream=stream0)
        del arg163_1
        del arg164_1
        del arg165_1
        del buf243
        buf248 = empty_strided_cuda((768, 50268), (50272, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_9.run(arg2_1, buf248, 38605824, grid=grid(38605824), stream=stream0)
        del arg2_1
        buf249 = empty_strided_cuda((50268, ), (1, ), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_10.run(arg166_1, buf249, 50268, grid=grid(50268), stream=stream0)
        del arg166_1
        buf250 = empty_strided_cuda((4096, 50268), (50272, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.addmm(buf249, reinterpret_tensor(buf247, (4096, 768), (768, 1), 0), buf248, alpha=1, beta=1, out=buf250)
        del buf247
        del buf248
        del buf249
        buf251 = empty_strided_cuda((4096, 1), (1, 4096), torch.float32)
        buf252 = empty_strided_cuda((4096, 1), (1, 4096), torch.float32)
        # Topologically Sorted Source Nodes: [masked_lm_loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_11.run(buf250, buf251, buf252, 4096, 50265, grid=grid(4096), stream=stream0)
        buf253 = empty_strided_cuda((), (), torch.float32)
        buf255 = buf253; del buf253  # reuse
        # Topologically Sorted Source Nodes: [masked_lm_loss], Original ATen: [aten.nll_loss_forward]
        triton_red_fused_nll_loss_forward_12.run(buf255, arg167_1, buf250, buf251, buf252, 1, 4096, grid=grid(1), stream=stream0)
        del arg167_1
        del buf251
        del buf252
    return (buf255, reinterpret_tensor(buf250, (8, 512, 50265), (25739264, 50272, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg166_1 = rand_strided((50265, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg167_1 = rand_strided((8, 512), (512, 1), device='cuda:0', dtype=torch.int64)
