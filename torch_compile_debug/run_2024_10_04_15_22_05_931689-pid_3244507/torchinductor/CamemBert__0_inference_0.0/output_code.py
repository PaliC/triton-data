...
# kernel path: /tmp/torchinductor_sahanp/fd/cfdaz3mw27zhii6vo6wdcjcxlaq6ebj45cpe5hqerguwazqnehd4.py
...
# kernel path: /tmp/torchinductor_sahanp/zs/czsdptwcw3deqsga34q23dslfu6xyaibpadbifyy3on6xi625nvm.py
...
# kernel path: /tmp/torchinductor_sahanp/73/c73lowxjqjndyms73vjs5qqemqglybt3okiv3473gd3o6e5f4m2n.py
...
# kernel path: /tmp/torchinductor_sahanp/ai/caiwbaig6glsbhx64o2k2iskfpuq4avsjgomhub4zzak2xb7dxba.py
...
#   %add_92 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_91, %arg202_1), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/46/c46xvdhsl2ucoju7phhyedo2q4mw6kcwtlcqqyhyyxou6k3iz53l.py
...
# kernel path: /tmp/torchinductor_sahanp/ol/colhlmuy44igg5dhnmwrxzk4vmtwcivggjhbidy3a4fq54ypsuyo.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default_1 : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%arg203_1, %full_default_3],), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/wc/cwcplkztbdmz6gu63wofehjzhnhwsioed5lfcdfvlk6h6evt4kxo.py
...
# kernel path: /tmp/torchinductor_sahanp/y3/cy3mlf6xlchxvqtpjmvjbwzb32i76clz6u6d5aeosfilafpsbyi2.py
# Topologically Sorted Source Nodes: [masked_lm_loss], Original ATen: [aten.nll_loss_forward]
# Source node to ATen node mapping:
#   masked_lm_loss => convert_element_type_4, div, full_default_1, ne_2, ne_3, neg, sum_2, sum_3, where_2
# Graph fragment:
...
def call(args):
    ...
    assert_size_stride(arg2_1, (32005, 768), (768, 1))
    ...
    assert_size_stride(arg203_1, (32005, ), (1, ))
    assert_size_stride(arg204_1, (16, 512), (512, 1))
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf257, (8192, 768), (768, 1), 0), reinterpret_tensor(arg199_1, (768, 768), (1, 768), 0), out=buf258)
        del arg199_1
        buf262 = buf257; del buf257  # reuse
        # Topologically Sorted Source Nodes: [x_37, x_38], Original ATen: [aten.gelu, aten.native_layer_norm]
        triton_per_fused_gelu_native_layer_norm_5.run(buf258, arg200_1, arg201_1, arg202_1, buf262, 8192, 768, grid=grid(8192), stream=stream0)
        del arg200_1
        del arg201_1
        del arg202_1
        del buf258
        buf263 = empty_strided_cuda((768, 32008), (32032, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_6.run(arg2_1, buf263, 24582144, grid=grid(24582144), stream=stream0)
        del arg2_1
        buf264 = empty_strided_cuda((32008, ), (1, ), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_7.run(arg203_1, buf264, 32008, grid=grid(32008), stream=stream0)
        del arg203_1
        buf265 = empty_strided_cuda((8192, 32008), (32032, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        ...
        buf267 = empty_strided_cuda((8192, 1), (1, 8192), torch.float32)
        # Topologically Sorted Source Nodes: [masked_lm_loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_8.run(buf265, buf266, buf267, 8192, 32005, grid=grid(8192), stream=stream0)
        buf268 = empty_strided_cuda((), (), torch.float32)
        buf270 = buf268; del buf268  # reuse
        # Topologically Sorted Source Nodes: [masked_lm_loss], Original ATen: [aten.nll_loss_forward]
        triton_red_fused_nll_loss_forward_9.run(buf270, arg204_1, buf265, buf266, buf267, 1, 8192, grid=grid(1), stream=stream0)
        del arg204_1
        del buf266
        del buf267
    return (buf270, reinterpret_tensor(buf265, (16, 512, 32005), (16400384, 32032, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((32005, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg203_1 = rand_strided((32005, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg204_1 = rand_strided((16, 512), (512, 1), device='cuda:0', dtype=torch.int64)
