...
# kernel path: /tmp/torchinductor_sahanp/nq/cnqvu2pin5ly4vtbpgynd4awkz6fjcbmuj4y6nba6n7dm3lvbrmq.py
...
# kernel path: /tmp/torchinductor_sahanp/is/cisaq6m4ifenjy5jp5r5mwlzqyfu6nnz77eww6endsvhu4ifigqn.py
...
# kernel path: /tmp/torchinductor_sahanp/vf/cvfota5tyxvkb4ivfylxyf2hsxdjymau3xwiakzxrf46exlqvr6k.py
# Topologically Sorted Source Nodes: [start_positions, start_loss, end_positions, end_loss, add_25, total_loss], Original ATen: [aten.clamp, aten.nll_loss_forward, aten.add, aten.div]
# Source node to ATen node mapping:
#   add_25 => add_88
...
#   total_loss => div_2
# Graph fragment:
#   %clamp_min : [num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%arg202_1, 0), kwargs = {})
...
#   %clamp_min_1 : [num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%arg203_1, 0), kwargs = {})
...
#   %add_88 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%div, %div_1), kwargs = {})
#   %div_2 : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%add_88, 2), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg200_1, (2, 768), (768, 1))
    assert_size_stride(arg201_1, (2, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        del buf249
        del buf252
        buf257 = empty_strided_cuda((8192, 2), (2, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf256, (8192, 768), (768, 1), 0), reinterpret_tensor(arg200_1, (768, 2), (1, 768), 0), out=buf257)
        del arg200_1
        del buf256
        buf258 = empty_strided_cuda((16, 512), (512, 1), torch.float32)
        buf259 = empty_strided_cuda((16, 1), (1, 16), torch.float32)
        buf260 = empty_strided_cuda((16, 1), (1, 16), torch.float32)
        # Topologically Sorted Source Nodes: [start_logits_1, start_loss], Original ATen: [aten.clone, aten._log_softmax]
        triton_red_fused__log_softmax_clone_4.run(buf257, arg201_1, buf258, buf259, buf260, 16, 512, grid=grid(16), stream=stream0)
        buf263 = empty_strided_cuda((16, 512), (512, 1), torch.float32)
        buf264 = empty_strided_cuda((16, 1), (1, 16), torch.float32)
        buf265 = empty_strided_cuda((16, 1), (1, 16), torch.float32)
        # Topologically Sorted Source Nodes: [end_logits_1, end_loss], Original ATen: [aten.clone, aten._log_softmax]
        triton_red_fused__log_softmax_clone_5.run(buf257, arg201_1, buf263, buf264, buf265, 16, 512, grid=grid(16), stream=stream0)
        del arg201_1
        del buf257
        buf261 = empty_strided_cuda((), (), torch.float32)
        buf268 = buf261; del buf261  # reuse
        # Topologically Sorted Source Nodes: [start_positions, start_loss, end_positions, end_loss, add_25, total_loss], Original ATen: [aten.clamp, aten.nll_loss_forward, aten.add, aten.div]
        triton_per_fused_add_clamp_div_nll_loss_forward_6.run(buf268, arg202_1, buf258, buf259, buf260, arg203_1, buf263, buf264, buf265, 1, 16, grid=grid(1), stream=stream0)
        del arg202_1
        del arg203_1
        del buf259
        del buf260
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg200_1 = rand_strided((2, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    arg201_1 = rand_strided((2, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg202_1 = rand_strided((16, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg203_1 = rand_strided((16, ), (1, ), device='cuda:0', dtype=torch.int64)
