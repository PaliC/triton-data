...
# kernel path: /tmp/torchinductor_sahanp/sf/csfovh3sie5wgrqbw2y7qrfhjahe3d2cysqx5chxrnmuzy7dqdfj.py
# Topologically Sorted Source Nodes: [], Original ATen: []
# Source node to ATen node mapping:
# Graph fragment:
#   %cat_default : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%permute_121, %full_default_4], 1), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/bi/cbimep33say3rlwimwghpsye5lte7epegq23vytigjcu3zs34pgf.py
# Topologically Sorted Source Nodes: [start_logits_1, start_loss], Original ATen: [aten.clone, aten._log_softmax]
# Source node to ATen node mapping:
#   start_logits_1 => clone_13
#   start_loss => amax, exp, sub_26, sum_1
# Graph fragment:
#   %clone_13 : [num_users=3] = call_function[target=torch.ops.aten.clone.default](args = (%squeeze,), kwargs = {memory_format: torch.contiguous_format})
#   %amax : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%clone_13, [1], True), kwargs = {})
#   %sub_26 : [num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_13, %amax), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/ap/capux5nhqj76d6fqmch7hnuwm4iog5vmmfatmppkk6vnrlq7qhlo.py
# Topologically Sorted Source Nodes: [end_logits_1, end_loss], Original ATen: [aten.clone, aten._log_softmax]
# Source node to ATen node mapping:
#   end_logits_1 => clone_14
#   end_loss => amax_1, exp_1, sub_28, sum_4
# Graph fragment:
#   %clone_14 : [num_users=3] = call_function[target=torch.ops.aten.clone.default](args = (%squeeze_1,), kwargs = {memory_format: torch.contiguous_format})
#   %amax_1 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%clone_14, [1], True), kwargs = {})
#   %sub_28 : [num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_14, %amax_1), kwargs = {})
...
triton_red_fused__log_softmax_clone_7 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /tmp/torchinductor_sahanp/fl/cflzooeib422yluiccggasejaf5i2pfoksmcmmatv5hfwg5j5fa6.py
# Topologically Sorted Source Nodes: [start_positions, start_loss, end_positions, end_loss, add_49, total_loss], Original ATen: [aten.clamp, aten.nll_loss_forward, aten.add, aten.div]
# Source node to ATen node mapping:
#   add_49 => add_100
...
#   total_loss => div_2
# Graph fragment:
#   %clamp_min : [num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%arg28_1, 0), kwargs = {})
...
#   %clamp_min_1 : [num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%arg29_1, 0), kwargs = {})
...
#   %add_100 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%div, %div_1), kwargs = {})
#   %div_2 : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%add_100, 2), kwargs = {})
triton_per_fused_add_clamp_div_nll_loss_forward_8 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
def call(args):
    ...
    assert_size_stride(arg26_1, (2, 4096), (4096, 1))
    assert_size_stride(arg27_1, (2, ), (1, ))
    assert_size_stride(arg28_1, (4, ), (1, ))
    assert_size_stride(arg29_1, (4, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        ...
        del buf250
        del buf253
        buf258 = empty_strided_cuda((4096, 4), (4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        triton_poi_fused_5.run(arg26_1, buf258, 16384, grid=grid(16384), stream=stream0)
        del arg26_1
        buf259 = empty_strided_cuda((2048, 4), (4, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf257, (2048, 4096), (4096, 1), 0), buf258, out=buf259)
        del buf257
        del buf258
        buf260 = empty_strided_cuda((4, 512), (512, 1), torch.float32)
        buf261 = empty_strided_cuda((4, 1), (1, 4), torch.float32)
        buf262 = empty_strided_cuda((4, 1), (1, 4), torch.float32)
        # Topologically Sorted Source Nodes: [start_logits_1, start_loss], Original ATen: [aten.clone, aten._log_softmax]
        triton_red_fused__log_softmax_clone_6.run(buf259, arg27_1, buf260, buf261, buf262, 4, 512, grid=grid(4), stream=stream0)
        buf265 = empty_strided_cuda((4, 512), (512, 1), torch.float32)
        buf266 = empty_strided_cuda((4, 1), (1, 4), torch.float32)
        buf267 = empty_strided_cuda((4, 1), (1, 4), torch.float32)
        # Topologically Sorted Source Nodes: [end_logits_1, end_loss], Original ATen: [aten.clone, aten._log_softmax]
        triton_red_fused__log_softmax_clone_7.run(buf259, arg27_1, buf265, buf266, buf267, 4, 512, grid=grid(4), stream=stream0)
        del arg27_1
        del buf259
        buf263 = empty_strided_cuda((), (), torch.float32)
        buf270 = buf263; del buf263  # reuse
        # Topologically Sorted Source Nodes: [start_positions, start_loss, end_positions, end_loss, add_49, total_loss], Original ATen: [aten.clamp, aten.nll_loss_forward, aten.add, aten.div]
        triton_per_fused_add_clamp_div_nll_loss_forward_8.run(buf270, arg28_1, buf260, buf261, buf262, arg29_1, buf265, buf266, buf267, 1, 4, grid=grid(1), stream=stream0)
        del arg28_1
        del arg29_1
        del buf261
        del buf262
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg26_1 = rand_strided((2, 4096), (4096, 1), device='cuda:0', dtype=torch.float32)
    arg27_1 = rand_strided((2, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg28_1 = rand_strided((4, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg29_1 = rand_strided((4, ), (1, ), device='cuda:0', dtype=torch.int64)
