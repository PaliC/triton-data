...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1, arg13_1, arg14_1, arg15_1, arg16_1, arg17_1, arg18_1, arg19_1, arg20_1, arg21_1, arg22_1, arg23_1, arg24_1, arg25_1, arg26_1, arg27_1, arg28_1, arg29_1):
        ...
        full_default_4 = torch.ops.aten.full.default([4096, 2], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        cat_default = torch.ops.aten.cat.default([permute_121, full_default_4], 1);  permute_121 = full_default_4 = None
        full_default_5 = torch.ops.aten.full.default([2], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
        cat_default_1 = torch.ops.aten.cat.default([arg27_1, full_default_5]);  arg27_1 = full_default_5 = None
        ...
        view_195 = torch.ops.aten.view.default(slice_tensor, [4, 512, 2]);  slice_tensor = None
        ...
        clone_13 = torch.ops.aten.clone.default(squeeze, memory_format = torch.contiguous_format);  squeeze = None
        squeeze_1 = torch.ops.aten.squeeze.dim(getitem_99, -1);  getitem_99 = None
        clone_14 = torch.ops.aten.clone.default(squeeze_1, memory_format = torch.contiguous_format);  squeeze_1 = None
        clamp_min = torch.ops.aten.clamp_min.default(arg28_1, 0);  arg28_1 = None
        clamp_max = torch.ops.aten.clamp_max.default(clamp_min, 512);  clamp_min = None
        clamp_min_1 = torch.ops.aten.clamp_min.default(arg29_1, 0);  arg29_1 = None
        clamp_max_1 = torch.ops.aten.clamp_max.default(clamp_min_1, 512);  clamp_min_1 = None
        amax = torch.ops.aten.amax.default(clone_13, [1], True)
        sub_26 = torch.ops.aten.sub.Tensor(clone_13, amax);  amax = None
        ...
        amax_1 = torch.ops.aten.amax.default(clone_14, [1], True)
        sub_28 = torch.ops.aten.sub.Tensor(clone_14, amax_1);  amax_1 = None
        ...
        add_100 = torch.ops.aten.add.Tensor(div, div_1);  div = div_1 = None
        div_2 = torch.ops.aten.div.Tensor(add_100, 2);  add_100 = None
...
def load_args(reader):
    ...
    buf26 = reader.storage(None, 32768, device=device(type='cuda', index=0))
    reader.tensor(buf26, (2, 4096), is_leaf=True)  # arg26_1
    buf27 = reader.storage(None, 8, device=device(type='cuda', index=0))
    reader.tensor(buf27, (2,), is_leaf=True)  # arg27_1
    buf28 = reader.storage(None, 32, device=device(type='cuda', index=0), dtype_hint=torch.int64)
    reader.tensor(buf28, (4,), dtype=torch.int64, is_leaf=True)  # arg28_1
    buf29 = reader.storage(None, 32, device=device(type='cuda', index=0), dtype_hint=torch.int64)
    reader.tensor(buf29, (4,), dtype=torch.int64, is_leaf=True)  # arg29_1
