...
# kernel path: /tmp/torchinductor_sahanp/kv/ckvbfgkuehnhkxzjqzpvsg546yhxsj65rcvbmb7vqzgqprrpzef5.py
# Topologically Sorted Source Nodes: [start_logits_1, start_loss], Original ATen: [aten.clone, aten._log_softmax]
# Source node to ATen node mapping:
#   start_logits_1 => clone_145
#   start_loss => amax_24, exp_24, sub_25, sum_25
# Graph fragment:
#   %clone_145 : [num_users=3] = call_function[target=torch.ops.aten.clone.default](args = (%squeeze,), kwargs = {memory_format: torch.contiguous_format})
#   %amax_24 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%clone_145, [1], True), kwargs = {})
#   %sub_25 : [num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_145, %amax_24), kwargs = {})
#   %exp_24 : [num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_25,), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/3t/c3t4263eb3p4dlwtvn7hmghhgmsotrvcbpo4ovzgruiwg7vbi5cf.py
# Topologically Sorted Source Nodes: [end_logits_1, end_loss], Original ATen: [aten.clone, aten._log_softmax]
# Source node to ATen node mapping:
#   end_logits_1 => clone_146
#   end_loss => amax_25, exp_25, sub_27, sum_28
# Graph fragment:
#   %clone_146 : [num_users=3] = call_function[target=torch.ops.aten.clone.default](args = (%squeeze_1,), kwargs = {memory_format: torch.contiguous_format})
#   %amax_25 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%clone_146, [1], True), kwargs = {})
#   %sub_27 : [num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%clone_146, %amax_25), kwargs = {})
#   %exp_25 : [num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_27,), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/te/cteqdbxslko5mwvaaf6iamd5nc3xnroeyjkiq5fhc6l66rmfcex7.py
# Topologically Sorted Source Nodes: [start_positions, start_loss, end_positions, end_loss, add_363, total_loss], Original ATen: [aten.clamp, aten.nll_loss_forward, aten.add, aten.div]
# Source node to ATen node mapping:
#   add_363 => add_363
...
#   total_loss => div_50
# Graph fragment:
#   %clamp_min : [num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%arg1115_1, 0), kwargs = {})
...
#   %clamp_min_1 : [num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%arg1116_1, 0), kwargs = {})
...
#   %add_363 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%div_48, %div_49), kwargs = {})
#   %div_50 : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%add_363, 2), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg1113_1, (2, 512), (512, 1))
    assert_size_stride(arg1114_1, (2, ), (1, ))
    assert_size_stride(arg1115_1, (128, ), (1, ))
    assert_size_stride(arg1116_1, (128, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        ...
        del arg1085_1
        del buf745
        buf747 = empty_strided_cuda((16384, 2), (2, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf746, (16384, 512), (512, 1), 0), reinterpret_tensor(arg1113_1, (512, 2), (1, 512), 0), out=buf747)
        del arg1113_1
        del buf746
        buf748 = empty_strided_cuda((128, 128), (128, 1), torch.float32)
        buf749 = empty_strided_cuda((128, 1), (1, 128), torch.float32)
        buf750 = empty_strided_cuda((128, 1), (1, 128), torch.float32)
        # Topologically Sorted Source Nodes: [start_logits_1, start_loss], Original ATen: [aten.clone, aten._log_softmax]
        triton_red_fused__log_softmax_clone_8.run(buf747, arg1114_1, buf748, buf749, buf750, 128, 128, grid=grid(128), stream=stream0)
        buf753 = empty_strided_cuda((128, 128), (128, 1), torch.float32)
        buf754 = empty_strided_cuda((128, 1), (1, 128), torch.float32)
        buf755 = empty_strided_cuda((128, 1), (1, 128), torch.float32)
        # Topologically Sorted Source Nodes: [end_logits_1, end_loss], Original ATen: [aten.clone, aten._log_softmax]
        triton_red_fused__log_softmax_clone_9.run(buf747, arg1114_1, buf753, buf754, buf755, 128, 128, grid=grid(128), stream=stream0)
        del arg1114_1
        del buf747
        buf751 = empty_strided_cuda((), (), torch.float32)
        buf758 = buf751; del buf751  # reuse
        # Topologically Sorted Source Nodes: [start_positions, start_loss, end_positions, end_loss, add_363, total_loss], Original ATen: [aten.clamp, aten.nll_loss_forward, aten.add, aten.div]
        triton_per_fused_add_clamp_div_nll_loss_forward_10.run(buf758, arg1115_1, buf748, buf749, buf750, arg1116_1, buf753, buf754, buf755, 1, 128, grid=grid(1), stream=stream0)
        del arg1115_1
        del arg1116_1
        del buf749
        del buf750
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1113_1 = rand_strided((2, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    arg1114_1 = rand_strided((2, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg1115_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg1116_1 = rand_strided((128, ), (1, ), device='cuda:0', dtype=torch.int64)
