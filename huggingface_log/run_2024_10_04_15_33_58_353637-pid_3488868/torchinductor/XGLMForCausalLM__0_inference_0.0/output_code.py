...
# kernel path: /tmp/torchinductor_sahanp/sm/csmdv2z7fh2szqyxjn26m2ksgcmxwog2sebnda4qhdbesh5yfgu4.py
...
# kernel path: /tmp/torchinductor_sahanp/m2/cm27jgrq5hm47lyyi43tjui2g7brwvjpu6zyfs2ecg2mcowupcnj.py
...
# kernel path: /tmp/torchinductor_sahanp/kt/cktm3kuvok7ksi4hgcsux4ey3f4i7hmdsxot3twax6gmtqtxptsp.py
...
# kernel path: /tmp/torchinductor_sahanp/ce/ccef6437j2osexelqcie6viglhhqw46kyjuzvm44hy2fv6woahrq.py
# Topologically Sorted Source Nodes: [attn_weights_4], Original ATen: [aten._softmax]
# Source node to ATen node mapping:
#   attn_weights_4 => amax, div, exp, sub_1, sum_1
# Graph fragment:
#   %amax : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%view_18, [-1], True), kwargs = {})
#   %sub_1 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_18, %amax), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/7r/c7red3nheopkvrbmyxiawmquzt2pkkpocyctk3oar2awz2wxnyrm.py
...
# kernel path: /tmp/torchinductor_sahanp/35/c35fjcqplxwbaibyvbuvcmythepqibrfenvxpyiqqhpbnj2k6l7i.py
...
# kernel path: /tmp/torchinductor_sahanp/t5/ct5klsyoanvyg72qv6f6otjaffopvuxpxsfini7nuisrttkqhjxq.py
...
# kernel path: /tmp/torchinductor_sahanp/6q/c6q7ntg2zyk2ezvsr54sdd5bnbzvaooxufww7perxivprue3tsyf.py
...
#   hidden_states_11 => add_11, add_12, mul_10, mul_9, rsqrt_2, sub_3, var_mean_2
# Graph fragment:
...
#   %sub_3 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_10, %getitem_5), kwargs = {})
...
#   %add_12 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_10, %arg20_1), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/lp/clpvua6pafwthlg5qxuaqpzfe6npvfgel6wqcnshrst77slcmx4h.py
...
#   hidden_states_14 => add_15, add_16, mul_12, mul_13, rsqrt_3, sub_5, var_mean_3
# Graph fragment:
#   %add_10 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_6, %view_26), kwargs = {})
...
#   %sub_5 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%add_14, %getitem_7), kwargs = {})
...
#   %add_16 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_13, %arg30_1), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/eh/cehpuytku44x223acavagkrbyvzatmm77kbyw5lophylz6bxdvc4.py
# Topologically Sorted Source Nodes: [loss], Original ATen: [aten._log_softmax]
# Source node to ATen node mapping:
#   loss => amax_24, exp_24, sub_73, sum_25
# Graph fragment:
#   %amax_24 : [num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%view_535, [1], True), kwargs = {})
#   %sub_73 : [num_users=2] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_535, %amax_24), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/be/cbeb4j3ncil2ywhmwxwa4sehoqhf3cluwz4y2n5bub3sgzmytcku.py
...
# Graph fragment:
#   %ne_1 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%view_537, -100), kwargs = {})
...
#   %where_2 : [num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_1, %neg, %full_default_28), kwargs = {})
#   %sum_27 : [num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%where_2,), kwargs = {})
#   %ne_2 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%view_537, -100), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg1_1, (256008, 1024), (1024, 1))
    assert_size_stride(arg2_1, (2050, 1024), (1024, 1))
    ...
    assert_size_stride(arg389_1, (8, 128), (128, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf3 = empty_strided_cuda((8, 128, 1024), (131072, 1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [embedding, inputs_embeds, hidden_states, hidden_states_2], Original ATen: [aten.embedding, aten.mul, aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_embedding_mul_native_layer_norm_0.run(arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, buf3, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg3_1
        del arg4_1
        ...
        del arg7_1
        buf6 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf5, arg8_1, buf6, 1048576, grid=grid(1048576), stream=stream0)
        del arg8_1
        buf7 = reinterpret_tensor(buf5, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf5  # reuse
        # Topologically Sorted Source Nodes: [contiguous_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf4, arg6_1, buf7, 1048576, grid=grid(1048576), stream=stream0)
        del arg6_1
        ...
        extern_kernels.bmm(reinterpret_tensor(buf7, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf6, (128, 64, 128), (8192, 1, 64), 0), out=buf8)
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf3, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg9_1, (1024, 1024), (1, 1024), 0), out=buf11)
        del arg9_1
        buf12 = reinterpret_tensor(buf3, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf3  # reuse
        # Topologically Sorted Source Nodes: [value_states], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf11, arg10_1, buf12, 1048576, grid=grid(1048576), stream=stream0)
        del arg10_1
        buf14 = reinterpret_tensor(buf11, (128, 128, 64), (8192, 64, 1), 0); del buf11  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_4, attn_output], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf13, reinterpret_tensor(buf12, (128, 128, 64), (8192, 64, 1), 0), out=buf14)
        buf15 = reinterpret_tensor(buf4, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf4  # reuse
        # Topologically Sorted Source Nodes: [attn_output_3], Original ATen: [aten.clone]
        ...
        del arg11_1
        buf17 = reinterpret_tensor(buf16, (8, 128, 1024), (131072, 1024, 1), 0); del buf16  # reuse
        buf21 = reinterpret_tensor(buf15, (8, 128, 1024), (131072, 1024, 1), 0); del buf15  # reuse
        # Topologically Sorted Source Nodes: [embedding, inputs_embeds, hidden_states, hidden_states_4, hidden_states_5], Original ATen: [aten.embedding, aten.mul, aten.add, aten.native_layer_norm]
        triton_per_fused_add_embedding_mul_native_layer_norm_5.run(buf17, arg0_1, arg1_1, arg2_1, arg12_1, arg13_1, arg14_1, buf21, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg0_1
        del arg12_1
        del arg13_1
        del arg14_1
        del arg2_1
        buf22 = empty_strided_cuda((1024, 4096), (4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf21, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg15_1, (1024, 4096), (1, 1024), 0), out=buf22)
        del arg15_1
        buf23 = reinterpret_tensor(buf22, (8, 128, 4096), (524288, 4096, 1), 0); del buf22  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_6], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf23, arg16_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg16_1
        buf24 = reinterpret_tensor(buf21, (1024, 1024), (1024, 1), 0); del buf21  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf23, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg17_1, (4096, 1024), (1, 4096), 0), out=buf24)
        del arg17_1
        buf28 = empty_strided_cuda((8, 128, 1024), (131072, 1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [hidden_states_10, hidden_states_11], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf17, buf24, arg18_1, arg19_1, arg20_1, buf28, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg19_1
        del arg20_1
        buf29 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf28, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg21_1, (1024, 1024), (1, 1024), 0), out=buf29)
        del arg21_1
        buf30 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf28, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg23_1, (1024, 1024), (1, 1024), 0), out=buf30)
        del arg23_1
        buf31 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf30, arg24_1, buf31, 1048576, grid=grid(1048576), stream=stream0)
        del arg24_1
        buf32 = reinterpret_tensor(buf30, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf30  # reuse
        # Topologically Sorted Source Nodes: [contiguous_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf29, arg22_1, buf32, 1048576, grid=grid(1048576), stream=stream0)
        del arg22_1
        buf33 = buf13; del buf13  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf32, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf31, (128, 64, 128), (8192, 1, 64), 0), out=buf33)
        ...
        buf36 = reinterpret_tensor(buf32, (1024, 1024), (1024, 1), 0); del buf32  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf28, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg25_1, (1024, 1024), (1, 1024), 0), out=buf36)
        del arg25_1
        buf37 = reinterpret_tensor(buf28, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf28  # reuse
        # Topologically Sorted Source Nodes: [value_states_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf36, arg26_1, buf37, 1048576, grid=grid(1048576), stream=stream0)
        del arg26_1
        buf39 = reinterpret_tensor(buf36, (128, 128, 64), (8192, 64, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_9, attn_output_5], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf38, reinterpret_tensor(buf37, (128, 128, 64), (8192, 64, 1), 0), out=buf39)
        buf40 = reinterpret_tensor(buf29, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf29  # reuse
        # Topologically Sorted Source Nodes: [attn_output_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf39, buf40, 1048576, grid=grid(1048576), stream=stream0)
        buf41 = reinterpret_tensor(buf39, (1024, 1024), (1024, 1), 0); del buf39  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf40, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg27_1, (1024, 1024), (1, 1024), 0), out=buf41)
        del arg27_1
        buf42 = reinterpret_tensor(buf41, (8, 128, 1024), (131072, 1024, 1), 0); del buf41  # reuse
        buf46 = reinterpret_tensor(buf40, (8, 128, 1024), (131072, 1024, 1), 0); del buf40  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_10, hidden_states_13, hidden_states_14], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_8.run(buf42, buf17, buf24, arg18_1, arg28_1, arg29_1, arg30_1, buf46, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg18_1
        del arg28_1
        del arg29_1
        del arg30_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf46, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg31_1, (1024, 4096), (1, 1024), 0), out=buf47)
        del arg31_1
        buf48 = reinterpret_tensor(buf47, (8, 128, 4096), (524288, 4096, 1), 0); del buf47  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_15], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf48, arg32_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg32_1
        buf49 = reinterpret_tensor(buf46, (1024, 1024), (1024, 1), 0); del buf46  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf48, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg33_1, (4096, 1024), (1, 4096), 0), out=buf49)
        del arg33_1
        buf53 = reinterpret_tensor(buf24, (8, 128, 1024), (131072, 1024, 1), 0); del buf24  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_19, hidden_states_20], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf42, buf49, arg34_1, arg35_1, arg36_1, buf53, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg35_1
        del arg36_1
        buf54 = reinterpret_tensor(buf17, (1024, 1024), (1024, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf53, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg37_1, (1024, 1024), (1, 1024), 0), out=buf54)
        del arg37_1
        buf55 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf53, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg39_1, (1024, 1024), (1, 1024), 0), out=buf55)
        del arg39_1
        buf56 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf55, arg40_1, buf56, 1048576, grid=grid(1048576), stream=stream0)
        del arg40_1
        buf57 = reinterpret_tensor(buf55, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf55  # reuse
        # Topologically Sorted Source Nodes: [contiguous_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf54, arg38_1, buf57, 1048576, grid=grid(1048576), stream=stream0)
        del arg38_1
        buf58 = buf38; del buf38  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_10], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf57, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf56, (128, 64, 128), (8192, 1, 64), 0), out=buf58)
        ...
        buf61 = reinterpret_tensor(buf57, (1024, 1024), (1024, 1), 0); del buf57  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf53, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg41_1, (1024, 1024), (1, 1024), 0), out=buf61)
        del arg41_1
        buf62 = reinterpret_tensor(buf53, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf53  # reuse
        # Topologically Sorted Source Nodes: [value_states_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf61, arg42_1, buf62, 1048576, grid=grid(1048576), stream=stream0)
        del arg42_1
        buf64 = reinterpret_tensor(buf61, (128, 128, 64), (8192, 64, 1), 0); del buf61  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_14, attn_output_10], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf63, reinterpret_tensor(buf62, (128, 128, 64), (8192, 64, 1), 0), out=buf64)
        buf65 = reinterpret_tensor(buf54, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf54  # reuse
        # Topologically Sorted Source Nodes: [attn_output_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf64, buf65, 1048576, grid=grid(1048576), stream=stream0)
        buf66 = reinterpret_tensor(buf64, (1024, 1024), (1024, 1), 0); del buf64  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf65, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg43_1, (1024, 1024), (1, 1024), 0), out=buf66)
        del arg43_1
        buf67 = reinterpret_tensor(buf66, (8, 128, 1024), (131072, 1024, 1), 0); del buf66  # reuse
        buf71 = reinterpret_tensor(buf65, (8, 128, 1024), (131072, 1024, 1), 0); del buf65  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf67, buf42, buf49, arg34_1, arg44_1, arg45_1, arg46_1, buf71, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg34_1
        del arg44_1
        del arg45_1
        del arg46_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf71, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg47_1, (1024, 4096), (1, 1024), 0), out=buf72)
        del arg47_1
        buf73 = reinterpret_tensor(buf72, (8, 128, 4096), (524288, 4096, 1), 0); del buf72  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_24], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf73, arg48_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg48_1
        buf74 = reinterpret_tensor(buf71, (1024, 1024), (1024, 1), 0); del buf71  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf73, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg49_1, (4096, 1024), (1, 4096), 0), out=buf74)
        del arg49_1
        buf78 = reinterpret_tensor(buf49, (8, 128, 1024), (131072, 1024, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_28, hidden_states_29], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf67, buf74, arg50_1, arg51_1, arg52_1, buf78, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg51_1
        del arg52_1
        buf79 = reinterpret_tensor(buf42, (1024, 1024), (1024, 1), 0); del buf42  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg53_1, (1024, 1024), (1, 1024), 0), out=buf79)
        del arg53_1
        buf80 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg55_1, (1024, 1024), (1, 1024), 0), out=buf80)
        del arg55_1
        buf81 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf80, arg56_1, buf81, 1048576, grid=grid(1048576), stream=stream0)
        del arg56_1
        buf82 = reinterpret_tensor(buf80, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf80  # reuse
        # Topologically Sorted Source Nodes: [contiguous_11], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf79, arg54_1, buf82, 1048576, grid=grid(1048576), stream=stream0)
        del arg54_1
        buf83 = buf63; del buf63  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_15], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf82, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf81, (128, 64, 128), (8192, 1, 64), 0), out=buf83)
        ...
        buf86 = reinterpret_tensor(buf82, (1024, 1024), (1024, 1), 0); del buf82  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg57_1, (1024, 1024), (1, 1024), 0), out=buf86)
        del arg57_1
        buf87 = reinterpret_tensor(buf78, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf78  # reuse
        # Topologically Sorted Source Nodes: [value_states_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf86, arg58_1, buf87, 1048576, grid=grid(1048576), stream=stream0)
        del arg58_1
        buf89 = reinterpret_tensor(buf86, (128, 128, 64), (8192, 64, 1), 0); del buf86  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_19, attn_output_15], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf88, reinterpret_tensor(buf87, (128, 128, 64), (8192, 64, 1), 0), out=buf89)
        buf90 = reinterpret_tensor(buf79, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [attn_output_18], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf89, buf90, 1048576, grid=grid(1048576), stream=stream0)
        buf91 = reinterpret_tensor(buf89, (1024, 1024), (1024, 1), 0); del buf89  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf90, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg59_1, (1024, 1024), (1, 1024), 0), out=buf91)
        del arg59_1
        buf92 = reinterpret_tensor(buf91, (8, 128, 1024), (131072, 1024, 1), 0); del buf91  # reuse
        buf96 = reinterpret_tensor(buf90, (8, 128, 1024), (131072, 1024, 1), 0); del buf90  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf92, buf67, buf74, arg50_1, arg60_1, arg61_1, arg62_1, buf96, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg50_1
        del arg60_1
        del arg61_1
        del arg62_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg63_1, (1024, 4096), (1, 1024), 0), out=buf97)
        del arg63_1
        buf98 = reinterpret_tensor(buf97, (8, 128, 4096), (524288, 4096, 1), 0); del buf97  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_33], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf98, arg64_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg64_1
        buf99 = reinterpret_tensor(buf96, (1024, 1024), (1024, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg65_1, (4096, 1024), (1, 4096), 0), out=buf99)
        del arg65_1
        buf103 = reinterpret_tensor(buf74, (8, 128, 1024), (131072, 1024, 1), 0); del buf74  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_37, hidden_states_38], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf92, buf99, arg66_1, arg67_1, arg68_1, buf103, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg67_1
        del arg68_1
        buf104 = reinterpret_tensor(buf67, (1024, 1024), (1024, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg69_1, (1024, 1024), (1, 1024), 0), out=buf104)
        del arg69_1
        buf105 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg71_1, (1024, 1024), (1, 1024), 0), out=buf105)
        del arg71_1
        buf106 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf105, arg72_1, buf106, 1048576, grid=grid(1048576), stream=stream0)
        del arg72_1
        buf107 = reinterpret_tensor(buf105, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf105  # reuse
        # Topologically Sorted Source Nodes: [contiguous_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf104, arg70_1, buf107, 1048576, grid=grid(1048576), stream=stream0)
        del arg70_1
        buf108 = buf88; del buf88  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_20], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf107, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf106, (128, 64, 128), (8192, 1, 64), 0), out=buf108)
        ...
        buf111 = reinterpret_tensor(buf107, (1024, 1024), (1024, 1), 0); del buf107  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf103, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg73_1, (1024, 1024), (1, 1024), 0), out=buf111)
        del arg73_1
        buf112 = reinterpret_tensor(buf103, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [value_states_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf111, arg74_1, buf112, 1048576, grid=grid(1048576), stream=stream0)
        del arg74_1
        buf114 = reinterpret_tensor(buf111, (128, 128, 64), (8192, 64, 1), 0); del buf111  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_24, attn_output_20], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf113, reinterpret_tensor(buf112, (128, 128, 64), (8192, 64, 1), 0), out=buf114)
        buf115 = reinterpret_tensor(buf104, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf104  # reuse
        # Topologically Sorted Source Nodes: [attn_output_23], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf114, buf115, 1048576, grid=grid(1048576), stream=stream0)
        buf116 = reinterpret_tensor(buf114, (1024, 1024), (1024, 1), 0); del buf114  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf115, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg75_1, (1024, 1024), (1, 1024), 0), out=buf116)
        del arg75_1
        buf117 = reinterpret_tensor(buf116, (8, 128, 1024), (131072, 1024, 1), 0); del buf116  # reuse
        buf121 = reinterpret_tensor(buf115, (8, 128, 1024), (131072, 1024, 1), 0); del buf115  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf117, buf92, buf99, arg66_1, arg76_1, arg77_1, arg78_1, buf121, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg66_1
        del arg76_1
        del arg77_1
        del arg78_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf121, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg79_1, (1024, 4096), (1, 1024), 0), out=buf122)
        del arg79_1
        buf123 = reinterpret_tensor(buf122, (8, 128, 4096), (524288, 4096, 1), 0); del buf122  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_42], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf123, arg80_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg80_1
        buf124 = reinterpret_tensor(buf121, (1024, 1024), (1024, 1), 0); del buf121  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg81_1, (4096, 1024), (1, 4096), 0), out=buf124)
        del arg81_1
        buf128 = reinterpret_tensor(buf99, (8, 128, 1024), (131072, 1024, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_46, hidden_states_47], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf117, buf124, arg82_1, arg83_1, arg84_1, buf128, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg83_1
        del arg84_1
        buf129 = reinterpret_tensor(buf92, (1024, 1024), (1024, 1), 0); del buf92  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg85_1, (1024, 1024), (1, 1024), 0), out=buf129)
        del arg85_1
        buf130 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg87_1, (1024, 1024), (1, 1024), 0), out=buf130)
        del arg87_1
        buf131 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf130, arg88_1, buf131, 1048576, grid=grid(1048576), stream=stream0)
        del arg88_1
        buf132 = reinterpret_tensor(buf130, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf130  # reuse
        # Topologically Sorted Source Nodes: [contiguous_17], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf129, arg86_1, buf132, 1048576, grid=grid(1048576), stream=stream0)
        del arg86_1
        buf133 = buf113; del buf113  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_25], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf132, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf131, (128, 64, 128), (8192, 1, 64), 0), out=buf133)
        ...
        buf136 = reinterpret_tensor(buf132, (1024, 1024), (1024, 1), 0); del buf132  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf128, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg89_1, (1024, 1024), (1, 1024), 0), out=buf136)
        del arg89_1
        buf137 = reinterpret_tensor(buf128, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf128  # reuse
        # Topologically Sorted Source Nodes: [value_states_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf136, arg90_1, buf137, 1048576, grid=grid(1048576), stream=stream0)
        del arg90_1
        buf139 = reinterpret_tensor(buf136, (128, 128, 64), (8192, 64, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_29, attn_output_25], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf138, reinterpret_tensor(buf137, (128, 128, 64), (8192, 64, 1), 0), out=buf139)
        buf140 = reinterpret_tensor(buf129, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf129  # reuse
        # Topologically Sorted Source Nodes: [attn_output_28], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf139, buf140, 1048576, grid=grid(1048576), stream=stream0)
        buf141 = reinterpret_tensor(buf139, (1024, 1024), (1024, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg91_1, (1024, 1024), (1, 1024), 0), out=buf141)
        del arg91_1
        buf142 = reinterpret_tensor(buf141, (8, 128, 1024), (131072, 1024, 1), 0); del buf141  # reuse
        buf146 = reinterpret_tensor(buf140, (8, 128, 1024), (131072, 1024, 1), 0); del buf140  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf142, buf117, buf124, arg82_1, arg92_1, arg93_1, arg94_1, buf146, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg82_1
        del arg92_1
        del arg93_1
        del arg94_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf146, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg95_1, (1024, 4096), (1, 1024), 0), out=buf147)
        del arg95_1
        buf148 = reinterpret_tensor(buf147, (8, 128, 4096), (524288, 4096, 1), 0); del buf147  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_51], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf148, arg96_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg96_1
        buf149 = reinterpret_tensor(buf146, (1024, 1024), (1024, 1), 0); del buf146  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf148, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg97_1, (4096, 1024), (1, 4096), 0), out=buf149)
        del arg97_1
        buf153 = reinterpret_tensor(buf124, (8, 128, 1024), (131072, 1024, 1), 0); del buf124  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_55, hidden_states_56], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf142, buf149, arg98_1, arg99_1, arg100_1, buf153, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg100_1
        del arg99_1
        buf154 = reinterpret_tensor(buf117, (1024, 1024), (1024, 1), 0); del buf117  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg101_1, (1024, 1024), (1, 1024), 0), out=buf154)
        del arg101_1
        buf155 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg103_1, (1024, 1024), (1, 1024), 0), out=buf155)
        del arg103_1
        buf156 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf155, arg104_1, buf156, 1048576, grid=grid(1048576), stream=stream0)
        del arg104_1
        buf157 = reinterpret_tensor(buf155, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf155  # reuse
        # Topologically Sorted Source Nodes: [contiguous_20], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf154, arg102_1, buf157, 1048576, grid=grid(1048576), stream=stream0)
        del arg102_1
        buf158 = buf138; del buf138  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_30], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf157, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf156, (128, 64, 128), (8192, 1, 64), 0), out=buf158)
        ...
        buf161 = reinterpret_tensor(buf157, (1024, 1024), (1024, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf153, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg105_1, (1024, 1024), (1, 1024), 0), out=buf161)
        del arg105_1
        buf162 = reinterpret_tensor(buf153, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf153  # reuse
        # Topologically Sorted Source Nodes: [value_states_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf161, arg106_1, buf162, 1048576, grid=grid(1048576), stream=stream0)
        del arg106_1
        buf164 = reinterpret_tensor(buf161, (128, 128, 64), (8192, 64, 1), 0); del buf161  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_34, attn_output_30], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf163, reinterpret_tensor(buf162, (128, 128, 64), (8192, 64, 1), 0), out=buf164)
        buf165 = reinterpret_tensor(buf154, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf154  # reuse
        # Topologically Sorted Source Nodes: [attn_output_33], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf164, buf165, 1048576, grid=grid(1048576), stream=stream0)
        buf166 = reinterpret_tensor(buf164, (1024, 1024), (1024, 1), 0); del buf164  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg107_1, (1024, 1024), (1, 1024), 0), out=buf166)
        del arg107_1
        buf167 = reinterpret_tensor(buf166, (8, 128, 1024), (131072, 1024, 1), 0); del buf166  # reuse
        buf171 = reinterpret_tensor(buf165, (8, 128, 1024), (131072, 1024, 1), 0); del buf165  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf167, buf142, buf149, arg98_1, arg108_1, arg109_1, arg110_1, buf171, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg108_1
        del arg109_1
        del arg110_1
        del arg98_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg111_1, (1024, 4096), (1, 1024), 0), out=buf172)
        del arg111_1
        buf173 = reinterpret_tensor(buf172, (8, 128, 4096), (524288, 4096, 1), 0); del buf172  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_60], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf173, arg112_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg112_1
        buf174 = reinterpret_tensor(buf171, (1024, 1024), (1024, 1), 0); del buf171  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf173, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg113_1, (4096, 1024), (1, 4096), 0), out=buf174)
        del arg113_1
        buf178 = reinterpret_tensor(buf149, (8, 128, 1024), (131072, 1024, 1), 0); del buf149  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_64, hidden_states_65], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf167, buf174, arg114_1, arg115_1, arg116_1, buf178, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg115_1
        del arg116_1
        buf179 = reinterpret_tensor(buf142, (1024, 1024), (1024, 1), 0); del buf142  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf178, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg117_1, (1024, 1024), (1, 1024), 0), out=buf179)
        del arg117_1
        buf180 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf178, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg119_1, (1024, 1024), (1, 1024), 0), out=buf180)
        del arg119_1
        buf181 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf180, arg120_1, buf181, 1048576, grid=grid(1048576), stream=stream0)
        del arg120_1
        buf182 = reinterpret_tensor(buf180, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf180  # reuse
        # Topologically Sorted Source Nodes: [contiguous_23], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf179, arg118_1, buf182, 1048576, grid=grid(1048576), stream=stream0)
        del arg118_1
        buf183 = buf163; del buf163  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_35], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf182, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf181, (128, 64, 128), (8192, 1, 64), 0), out=buf183)
        ...
        buf186 = reinterpret_tensor(buf182, (1024, 1024), (1024, 1), 0); del buf182  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf178, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg121_1, (1024, 1024), (1, 1024), 0), out=buf186)
        del arg121_1
        buf187 = reinterpret_tensor(buf178, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf178  # reuse
        # Topologically Sorted Source Nodes: [value_states_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf186, arg122_1, buf187, 1048576, grid=grid(1048576), stream=stream0)
        del arg122_1
        buf189 = reinterpret_tensor(buf186, (128, 128, 64), (8192, 64, 1), 0); del buf186  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_39, attn_output_35], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf188, reinterpret_tensor(buf187, (128, 128, 64), (8192, 64, 1), 0), out=buf189)
        buf190 = reinterpret_tensor(buf179, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [attn_output_38], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf189, buf190, 1048576, grid=grid(1048576), stream=stream0)
        buf191 = reinterpret_tensor(buf189, (1024, 1024), (1024, 1), 0); del buf189  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf190, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg123_1, (1024, 1024), (1, 1024), 0), out=buf191)
        del arg123_1
        buf192 = reinterpret_tensor(buf191, (8, 128, 1024), (131072, 1024, 1), 0); del buf191  # reuse
        buf196 = reinterpret_tensor(buf190, (8, 128, 1024), (131072, 1024, 1), 0); del buf190  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf192, buf167, buf174, arg114_1, arg124_1, arg125_1, arg126_1, buf196, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg114_1
        del arg124_1
        del arg125_1
        del arg126_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf196, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg127_1, (1024, 4096), (1, 1024), 0), out=buf197)
        del arg127_1
        buf198 = reinterpret_tensor(buf197, (8, 128, 4096), (524288, 4096, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_69], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf198, arg128_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg128_1
        buf199 = reinterpret_tensor(buf196, (1024, 1024), (1024, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf198, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg129_1, (4096, 1024), (1, 4096), 0), out=buf199)
        del arg129_1
        buf203 = reinterpret_tensor(buf174, (8, 128, 1024), (131072, 1024, 1), 0); del buf174  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_73, hidden_states_74], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf192, buf199, arg130_1, arg131_1, arg132_1, buf203, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg131_1
        del arg132_1
        buf204 = reinterpret_tensor(buf167, (1024, 1024), (1024, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf203, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg133_1, (1024, 1024), (1, 1024), 0), out=buf204)
        del arg133_1
        buf205 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf203, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg135_1, (1024, 1024), (1, 1024), 0), out=buf205)
        del arg135_1
        buf206 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf205, arg136_1, buf206, 1048576, grid=grid(1048576), stream=stream0)
        del arg136_1
        buf207 = reinterpret_tensor(buf205, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf205  # reuse
        # Topologically Sorted Source Nodes: [contiguous_26], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf204, arg134_1, buf207, 1048576, grid=grid(1048576), stream=stream0)
        del arg134_1
        buf208 = buf188; del buf188  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_40], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf207, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf206, (128, 64, 128), (8192, 1, 64), 0), out=buf208)
        ...
        buf211 = reinterpret_tensor(buf207, (1024, 1024), (1024, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf203, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg137_1, (1024, 1024), (1, 1024), 0), out=buf211)
        del arg137_1
        buf212 = reinterpret_tensor(buf203, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [value_states_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf211, arg138_1, buf212, 1048576, grid=grid(1048576), stream=stream0)
        del arg138_1
        buf214 = reinterpret_tensor(buf211, (128, 128, 64), (8192, 64, 1), 0); del buf211  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_44, attn_output_40], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf213, reinterpret_tensor(buf212, (128, 128, 64), (8192, 64, 1), 0), out=buf214)
        buf215 = reinterpret_tensor(buf204, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf204  # reuse
        # Topologically Sorted Source Nodes: [attn_output_43], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf214, buf215, 1048576, grid=grid(1048576), stream=stream0)
        buf216 = reinterpret_tensor(buf214, (1024, 1024), (1024, 1), 0); del buf214  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf215, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg139_1, (1024, 1024), (1, 1024), 0), out=buf216)
        del arg139_1
        buf217 = reinterpret_tensor(buf216, (8, 128, 1024), (131072, 1024, 1), 0); del buf216  # reuse
        buf221 = reinterpret_tensor(buf215, (8, 128, 1024), (131072, 1024, 1), 0); del buf215  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf217, buf192, buf199, arg130_1, arg140_1, arg141_1, arg142_1, buf221, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg130_1
        del arg140_1
        del arg141_1
        del arg142_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf221, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg143_1, (1024, 4096), (1, 1024), 0), out=buf222)
        del arg143_1
        buf223 = reinterpret_tensor(buf222, (8, 128, 4096), (524288, 4096, 1), 0); del buf222  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_78], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf223, arg144_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg144_1
        buf224 = reinterpret_tensor(buf221, (1024, 1024), (1024, 1), 0); del buf221  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf223, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg145_1, (4096, 1024), (1, 4096), 0), out=buf224)
        del arg145_1
        buf228 = reinterpret_tensor(buf199, (8, 128, 1024), (131072, 1024, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_82, hidden_states_83], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf217, buf224, arg146_1, arg147_1, arg148_1, buf228, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg147_1
        del arg148_1
        buf229 = reinterpret_tensor(buf192, (1024, 1024), (1024, 1), 0); del buf192  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf228, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg149_1, (1024, 1024), (1, 1024), 0), out=buf229)
        del arg149_1
        buf230 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf228, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg151_1, (1024, 1024), (1, 1024), 0), out=buf230)
        del arg151_1
        buf231 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_18], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf230, arg152_1, buf231, 1048576, grid=grid(1048576), stream=stream0)
        del arg152_1
        buf232 = reinterpret_tensor(buf230, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf230  # reuse
        # Topologically Sorted Source Nodes: [contiguous_29], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf229, arg150_1, buf232, 1048576, grid=grid(1048576), stream=stream0)
        del arg150_1
        buf233 = buf213; del buf213  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_45], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf232, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf231, (128, 64, 128), (8192, 1, 64), 0), out=buf233)
        ...
        buf236 = reinterpret_tensor(buf232, (1024, 1024), (1024, 1), 0); del buf232  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf228, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg153_1, (1024, 1024), (1, 1024), 0), out=buf236)
        del arg153_1
        buf237 = reinterpret_tensor(buf228, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf228  # reuse
        # Topologically Sorted Source Nodes: [value_states_18], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf236, arg154_1, buf237, 1048576, grid=grid(1048576), stream=stream0)
        del arg154_1
        buf239 = reinterpret_tensor(buf236, (128, 128, 64), (8192, 64, 1), 0); del buf236  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_49, attn_output_45], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf238, reinterpret_tensor(buf237, (128, 128, 64), (8192, 64, 1), 0), out=buf239)
        buf240 = reinterpret_tensor(buf229, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf229  # reuse
        # Topologically Sorted Source Nodes: [attn_output_48], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf239, buf240, 1048576, grid=grid(1048576), stream=stream0)
        buf241 = reinterpret_tensor(buf239, (1024, 1024), (1024, 1), 0); del buf239  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf240, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg155_1, (1024, 1024), (1, 1024), 0), out=buf241)
        del arg155_1
        buf242 = reinterpret_tensor(buf241, (8, 128, 1024), (131072, 1024, 1), 0); del buf241  # reuse
        buf246 = reinterpret_tensor(buf240, (8, 128, 1024), (131072, 1024, 1), 0); del buf240  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf242, buf217, buf224, arg146_1, arg156_1, arg157_1, arg158_1, buf246, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg146_1
        del arg156_1
        del arg157_1
        del arg158_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf246, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg159_1, (1024, 4096), (1, 1024), 0), out=buf247)
        del arg159_1
        buf248 = reinterpret_tensor(buf247, (8, 128, 4096), (524288, 4096, 1), 0); del buf247  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_87], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf248, arg160_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg160_1
        buf249 = reinterpret_tensor(buf246, (1024, 1024), (1024, 1), 0); del buf246  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf248, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg161_1, (4096, 1024), (1, 4096), 0), out=buf249)
        del arg161_1
        buf253 = reinterpret_tensor(buf224, (8, 128, 1024), (131072, 1024, 1), 0); del buf224  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_91, hidden_states_92], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf242, buf249, arg162_1, arg163_1, arg164_1, buf253, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg163_1
        del arg164_1
        buf254 = reinterpret_tensor(buf217, (1024, 1024), (1024, 1), 0); del buf217  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf253, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg165_1, (1024, 1024), (1, 1024), 0), out=buf254)
        del arg165_1
        buf255 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf253, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg167_1, (1024, 1024), (1, 1024), 0), out=buf255)
        del arg167_1
        buf256 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_20], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf255, arg168_1, buf256, 1048576, grid=grid(1048576), stream=stream0)
        del arg168_1
        buf257 = reinterpret_tensor(buf255, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf255  # reuse
        # Topologically Sorted Source Nodes: [contiguous_32], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf254, arg166_1, buf257, 1048576, grid=grid(1048576), stream=stream0)
        del arg166_1
        buf258 = buf238; del buf238  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_50], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf257, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf256, (128, 64, 128), (8192, 1, 64), 0), out=buf258)
        ...
        buf261 = reinterpret_tensor(buf257, (1024, 1024), (1024, 1), 0); del buf257  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf253, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg169_1, (1024, 1024), (1, 1024), 0), out=buf261)
        del arg169_1
        buf262 = reinterpret_tensor(buf253, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf253  # reuse
        # Topologically Sorted Source Nodes: [value_states_20], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf261, arg170_1, buf262, 1048576, grid=grid(1048576), stream=stream0)
        del arg170_1
        buf264 = reinterpret_tensor(buf261, (128, 128, 64), (8192, 64, 1), 0); del buf261  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_54, attn_output_50], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf263, reinterpret_tensor(buf262, (128, 128, 64), (8192, 64, 1), 0), out=buf264)
        buf265 = reinterpret_tensor(buf254, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf254  # reuse
        # Topologically Sorted Source Nodes: [attn_output_53], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf264, buf265, 1048576, grid=grid(1048576), stream=stream0)
        buf266 = reinterpret_tensor(buf264, (1024, 1024), (1024, 1), 0); del buf264  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf265, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg171_1, (1024, 1024), (1, 1024), 0), out=buf266)
        del arg171_1
        buf267 = reinterpret_tensor(buf266, (8, 128, 1024), (131072, 1024, 1), 0); del buf266  # reuse
        buf271 = reinterpret_tensor(buf265, (8, 128, 1024), (131072, 1024, 1), 0); del buf265  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf267, buf242, buf249, arg162_1, arg172_1, arg173_1, arg174_1, buf271, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg162_1
        del arg172_1
        del arg173_1
        del arg174_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf271, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg175_1, (1024, 4096), (1, 1024), 0), out=buf272)
        del arg175_1
        buf273 = reinterpret_tensor(buf272, (8, 128, 4096), (524288, 4096, 1), 0); del buf272  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_96], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf273, arg176_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg176_1
        buf274 = reinterpret_tensor(buf271, (1024, 1024), (1024, 1), 0); del buf271  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf273, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg177_1, (4096, 1024), (1, 4096), 0), out=buf274)
        del arg177_1
        buf278 = reinterpret_tensor(buf249, (8, 128, 1024), (131072, 1024, 1), 0); del buf249  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_100, hidden_states_101], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf267, buf274, arg178_1, arg179_1, arg180_1, buf278, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg179_1
        del arg180_1
        buf279 = reinterpret_tensor(buf242, (1024, 1024), (1024, 1), 0); del buf242  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf278, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg181_1, (1024, 1024), (1, 1024), 0), out=buf279)
        del arg181_1
        buf280 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf278, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg183_1, (1024, 1024), (1, 1024), 0), out=buf280)
        del arg183_1
        buf281 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_22], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf280, arg184_1, buf281, 1048576, grid=grid(1048576), stream=stream0)
        del arg184_1
        buf282 = reinterpret_tensor(buf280, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf280  # reuse
        # Topologically Sorted Source Nodes: [contiguous_35], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf279, arg182_1, buf282, 1048576, grid=grid(1048576), stream=stream0)
        del arg182_1
        buf283 = buf263; del buf263  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_55], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf282, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf281, (128, 64, 128), (8192, 1, 64), 0), out=buf283)
        ...
        buf286 = reinterpret_tensor(buf282, (1024, 1024), (1024, 1), 0); del buf282  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf278, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg185_1, (1024, 1024), (1, 1024), 0), out=buf286)
        del arg185_1
        buf287 = reinterpret_tensor(buf278, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf278  # reuse
        # Topologically Sorted Source Nodes: [value_states_22], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf286, arg186_1, buf287, 1048576, grid=grid(1048576), stream=stream0)
        del arg186_1
        buf289 = reinterpret_tensor(buf286, (128, 128, 64), (8192, 64, 1), 0); del buf286  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_59, attn_output_55], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf288, reinterpret_tensor(buf287, (128, 128, 64), (8192, 64, 1), 0), out=buf289)
        buf290 = reinterpret_tensor(buf279, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf279  # reuse
        # Topologically Sorted Source Nodes: [attn_output_58], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf289, buf290, 1048576, grid=grid(1048576), stream=stream0)
        buf291 = reinterpret_tensor(buf289, (1024, 1024), (1024, 1), 0); del buf289  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf290, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg187_1, (1024, 1024), (1, 1024), 0), out=buf291)
        del arg187_1
        buf292 = reinterpret_tensor(buf291, (8, 128, 1024), (131072, 1024, 1), 0); del buf291  # reuse
        buf296 = reinterpret_tensor(buf290, (8, 128, 1024), (131072, 1024, 1), 0); del buf290  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf292, buf267, buf274, arg178_1, arg188_1, arg189_1, arg190_1, buf296, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg178_1
        del arg188_1
        del arg189_1
        del arg190_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf296, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg191_1, (1024, 4096), (1, 1024), 0), out=buf297)
        del arg191_1
        buf298 = reinterpret_tensor(buf297, (8, 128, 4096), (524288, 4096, 1), 0); del buf297  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_105], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf298, arg192_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg192_1
        buf299 = reinterpret_tensor(buf296, (1024, 1024), (1024, 1), 0); del buf296  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf298, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg193_1, (4096, 1024), (1, 4096), 0), out=buf299)
        del arg193_1
        buf303 = reinterpret_tensor(buf274, (8, 128, 1024), (131072, 1024, 1), 0); del buf274  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_109, hidden_states_110], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf292, buf299, arg194_1, arg195_1, arg196_1, buf303, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg195_1
        del arg196_1
        buf304 = reinterpret_tensor(buf267, (1024, 1024), (1024, 1), 0); del buf267  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf303, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg197_1, (1024, 1024), (1, 1024), 0), out=buf304)
        del arg197_1
        buf305 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf303, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg199_1, (1024, 1024), (1, 1024), 0), out=buf305)
        del arg199_1
        buf306 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_24], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf305, arg200_1, buf306, 1048576, grid=grid(1048576), stream=stream0)
        del arg200_1
        buf307 = reinterpret_tensor(buf305, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf305  # reuse
        # Topologically Sorted Source Nodes: [contiguous_38], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf304, arg198_1, buf307, 1048576, grid=grid(1048576), stream=stream0)
        del arg198_1
        buf308 = buf288; del buf288  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_60], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf307, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf306, (128, 64, 128), (8192, 1, 64), 0), out=buf308)
        buf313 = buf283; del buf283  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_64], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf308, buf313, 16384, 128, grid=grid(16384), stream=stream0)
        buf311 = reinterpret_tensor(buf307, (1024, 1024), (1024, 1), 0); del buf307  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf303, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg201_1, (1024, 1024), (1, 1024), 0), out=buf311)
        del arg201_1
        buf312 = reinterpret_tensor(buf303, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf303  # reuse
        # Topologically Sorted Source Nodes: [value_states_24], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf311, arg202_1, buf312, 1048576, grid=grid(1048576), stream=stream0)
        del arg202_1
        buf314 = reinterpret_tensor(buf311, (128, 128, 64), (8192, 64, 1), 0); del buf311  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_64, attn_output_60], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf313, reinterpret_tensor(buf312, (128, 128, 64), (8192, 64, 1), 0), out=buf314)
        buf315 = reinterpret_tensor(buf304, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf304  # reuse
        # Topologically Sorted Source Nodes: [attn_output_63], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf314, buf315, 1048576, grid=grid(1048576), stream=stream0)
        buf316 = reinterpret_tensor(buf314, (1024, 1024), (1024, 1), 0); del buf314  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf315, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg203_1, (1024, 1024), (1, 1024), 0), out=buf316)
        del arg203_1
        buf317 = reinterpret_tensor(buf316, (8, 128, 1024), (131072, 1024, 1), 0); del buf316  # reuse
        buf321 = reinterpret_tensor(buf315, (8, 128, 1024), (131072, 1024, 1), 0); del buf315  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf317, buf292, buf299, arg194_1, arg204_1, arg205_1, arg206_1, buf321, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg194_1
        del arg204_1
        del arg205_1
        del arg206_1
        buf322 = reinterpret_tensor(buf298, (1024, 4096), (4096, 1), 0); del buf298  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf321, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg207_1, (1024, 4096), (1, 1024), 0), out=buf322)
        del arg207_1
        buf323 = reinterpret_tensor(buf322, (8, 128, 4096), (524288, 4096, 1), 0); del buf322  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_114], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf323, arg208_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg208_1
        buf324 = reinterpret_tensor(buf321, (1024, 1024), (1024, 1), 0); del buf321  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf323, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg209_1, (4096, 1024), (1, 4096), 0), out=buf324)
        del arg209_1
        buf328 = reinterpret_tensor(buf299, (8, 128, 1024), (131072, 1024, 1), 0); del buf299  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_118, hidden_states_119], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf317, buf324, arg210_1, arg211_1, arg212_1, buf328, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg211_1
        del arg212_1
        buf329 = reinterpret_tensor(buf292, (1024, 1024), (1024, 1), 0); del buf292  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf328, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg213_1, (1024, 1024), (1, 1024), 0), out=buf329)
        del arg213_1
        buf330 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf328, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg215_1, (1024, 1024), (1, 1024), 0), out=buf330)
        del arg215_1
        buf331 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_26], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf330, arg216_1, buf331, 1048576, grid=grid(1048576), stream=stream0)
        del arg216_1
        buf332 = reinterpret_tensor(buf330, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf330  # reuse
        # Topologically Sorted Source Nodes: [contiguous_41], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf329, arg214_1, buf332, 1048576, grid=grid(1048576), stream=stream0)
        del arg214_1
        buf333 = buf313; del buf313  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_65], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf332, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf331, (128, 64, 128), (8192, 1, 64), 0), out=buf333)
        ...
        buf336 = reinterpret_tensor(buf332, (1024, 1024), (1024, 1), 0); del buf332  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf328, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg217_1, (1024, 1024), (1, 1024), 0), out=buf336)
        del arg217_1
        buf337 = reinterpret_tensor(buf328, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf328  # reuse
        # Topologically Sorted Source Nodes: [value_states_26], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf336, arg218_1, buf337, 1048576, grid=grid(1048576), stream=stream0)
        del arg218_1
        buf339 = reinterpret_tensor(buf336, (128, 128, 64), (8192, 64, 1), 0); del buf336  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_69, attn_output_65], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf338, reinterpret_tensor(buf337, (128, 128, 64), (8192, 64, 1), 0), out=buf339)
        buf340 = reinterpret_tensor(buf329, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf329  # reuse
        # Topologically Sorted Source Nodes: [attn_output_68], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf339, buf340, 1048576, grid=grid(1048576), stream=stream0)
        buf341 = reinterpret_tensor(buf339, (1024, 1024), (1024, 1), 0); del buf339  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf340, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg219_1, (1024, 1024), (1, 1024), 0), out=buf341)
        del arg219_1
        buf342 = reinterpret_tensor(buf341, (8, 128, 1024), (131072, 1024, 1), 0); del buf341  # reuse
        buf346 = reinterpret_tensor(buf340, (8, 128, 1024), (131072, 1024, 1), 0); del buf340  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf342, buf317, buf324, arg210_1, arg220_1, arg221_1, arg222_1, buf346, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg210_1
        del arg220_1
        del arg221_1
        del arg222_1
        buf347 = reinterpret_tensor(buf323, (1024, 4096), (4096, 1), 0); del buf323  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf346, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg223_1, (1024, 4096), (1, 1024), 0), out=buf347)
        del arg223_1
        buf348 = reinterpret_tensor(buf347, (8, 128, 4096), (524288, 4096, 1), 0); del buf347  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_123], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf348, arg224_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg224_1
        buf349 = reinterpret_tensor(buf346, (1024, 1024), (1024, 1), 0); del buf346  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf348, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg225_1, (4096, 1024), (1, 4096), 0), out=buf349)
        del arg225_1
        buf353 = reinterpret_tensor(buf324, (8, 128, 1024), (131072, 1024, 1), 0); del buf324  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_127, hidden_states_128], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf342, buf349, arg226_1, arg227_1, arg228_1, buf353, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg227_1
        del arg228_1
        buf354 = reinterpret_tensor(buf317, (1024, 1024), (1024, 1), 0); del buf317  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf353, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg229_1, (1024, 1024), (1, 1024), 0), out=buf354)
        del arg229_1
        buf355 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf353, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg231_1, (1024, 1024), (1, 1024), 0), out=buf355)
        del arg231_1
        buf356 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_28], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf355, arg232_1, buf356, 1048576, grid=grid(1048576), stream=stream0)
        del arg232_1
        buf357 = reinterpret_tensor(buf355, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf355  # reuse
        # Topologically Sorted Source Nodes: [contiguous_44], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf354, arg230_1, buf357, 1048576, grid=grid(1048576), stream=stream0)
        del arg230_1
        buf358 = buf338; del buf338  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_70], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf357, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf356, (128, 64, 128), (8192, 1, 64), 0), out=buf358)
        buf363 = buf333; del buf333  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_74], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf358, buf363, 16384, 128, grid=grid(16384), stream=stream0)
        buf361 = reinterpret_tensor(buf357, (1024, 1024), (1024, 1), 0); del buf357  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf353, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg233_1, (1024, 1024), (1, 1024), 0), out=buf361)
        del arg233_1
        buf362 = reinterpret_tensor(buf353, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf353  # reuse
        # Topologically Sorted Source Nodes: [value_states_28], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf361, arg234_1, buf362, 1048576, grid=grid(1048576), stream=stream0)
        del arg234_1
        buf364 = reinterpret_tensor(buf361, (128, 128, 64), (8192, 64, 1), 0); del buf361  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_74, attn_output_70], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf363, reinterpret_tensor(buf362, (128, 128, 64), (8192, 64, 1), 0), out=buf364)
        buf365 = reinterpret_tensor(buf354, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf354  # reuse
        # Topologically Sorted Source Nodes: [attn_output_73], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf364, buf365, 1048576, grid=grid(1048576), stream=stream0)
        buf366 = reinterpret_tensor(buf364, (1024, 1024), (1024, 1), 0); del buf364  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf365, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg235_1, (1024, 1024), (1, 1024), 0), out=buf366)
        del arg235_1
        buf367 = reinterpret_tensor(buf366, (8, 128, 1024), (131072, 1024, 1), 0); del buf366  # reuse
        buf371 = reinterpret_tensor(buf365, (8, 128, 1024), (131072, 1024, 1), 0); del buf365  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf367, buf342, buf349, arg226_1, arg236_1, arg237_1, arg238_1, buf371, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg226_1
        del arg236_1
        del arg237_1
        del arg238_1
        buf372 = reinterpret_tensor(buf348, (1024, 4096), (4096, 1), 0); del buf348  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf371, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg239_1, (1024, 4096), (1, 1024), 0), out=buf372)
        del arg239_1
        buf373 = reinterpret_tensor(buf372, (8, 128, 4096), (524288, 4096, 1), 0); del buf372  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_132], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf373, arg240_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg240_1
        buf374 = reinterpret_tensor(buf371, (1024, 1024), (1024, 1), 0); del buf371  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf373, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg241_1, (4096, 1024), (1, 4096), 0), out=buf374)
        del arg241_1
        buf378 = reinterpret_tensor(buf349, (8, 128, 1024), (131072, 1024, 1), 0); del buf349  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_136, hidden_states_137], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf367, buf374, arg242_1, arg243_1, arg244_1, buf378, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg243_1
        del arg244_1
        buf379 = reinterpret_tensor(buf342, (1024, 1024), (1024, 1), 0); del buf342  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf378, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg245_1, (1024, 1024), (1, 1024), 0), out=buf379)
        del arg245_1
        buf380 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf378, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg247_1, (1024, 1024), (1, 1024), 0), out=buf380)
        del arg247_1
        buf381 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_30], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf380, arg248_1, buf381, 1048576, grid=grid(1048576), stream=stream0)
        del arg248_1
        buf382 = reinterpret_tensor(buf380, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf380  # reuse
        # Topologically Sorted Source Nodes: [contiguous_47], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf379, arg246_1, buf382, 1048576, grid=grid(1048576), stream=stream0)
        del arg246_1
        buf383 = buf363; del buf363  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_75], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf382, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf381, (128, 64, 128), (8192, 1, 64), 0), out=buf383)
        ...
        buf386 = reinterpret_tensor(buf382, (1024, 1024), (1024, 1), 0); del buf382  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf378, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg249_1, (1024, 1024), (1, 1024), 0), out=buf386)
        del arg249_1
        buf387 = reinterpret_tensor(buf378, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf378  # reuse
        # Topologically Sorted Source Nodes: [value_states_30], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf386, arg250_1, buf387, 1048576, grid=grid(1048576), stream=stream0)
        del arg250_1
        buf389 = reinterpret_tensor(buf386, (128, 128, 64), (8192, 64, 1), 0); del buf386  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_79, attn_output_75], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf388, reinterpret_tensor(buf387, (128, 128, 64), (8192, 64, 1), 0), out=buf389)
        buf390 = reinterpret_tensor(buf379, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf379  # reuse
        # Topologically Sorted Source Nodes: [attn_output_78], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf389, buf390, 1048576, grid=grid(1048576), stream=stream0)
        buf391 = reinterpret_tensor(buf389, (1024, 1024), (1024, 1), 0); del buf389  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf390, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg251_1, (1024, 1024), (1, 1024), 0), out=buf391)
        del arg251_1
        buf392 = reinterpret_tensor(buf391, (8, 128, 1024), (131072, 1024, 1), 0); del buf391  # reuse
        buf396 = reinterpret_tensor(buf390, (8, 128, 1024), (131072, 1024, 1), 0); del buf390  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf392, buf367, buf374, arg242_1, arg252_1, arg253_1, arg254_1, buf396, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg242_1
        del arg252_1
        del arg253_1
        del arg254_1
        buf397 = reinterpret_tensor(buf373, (1024, 4096), (4096, 1), 0); del buf373  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf396, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg255_1, (1024, 4096), (1, 1024), 0), out=buf397)
        del arg255_1
        buf398 = reinterpret_tensor(buf397, (8, 128, 4096), (524288, 4096, 1), 0); del buf397  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_141], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf398, arg256_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg256_1
        buf399 = reinterpret_tensor(buf396, (1024, 1024), (1024, 1), 0); del buf396  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf398, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg257_1, (4096, 1024), (1, 4096), 0), out=buf399)
        del arg257_1
        buf403 = reinterpret_tensor(buf374, (8, 128, 1024), (131072, 1024, 1), 0); del buf374  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_145, hidden_states_146], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf392, buf399, arg258_1, arg259_1, arg260_1, buf403, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg259_1
        del arg260_1
        buf404 = reinterpret_tensor(buf367, (1024, 1024), (1024, 1), 0); del buf367  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf403, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg261_1, (1024, 1024), (1, 1024), 0), out=buf404)
        del arg261_1
        buf405 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf403, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg263_1, (1024, 1024), (1, 1024), 0), out=buf405)
        del arg263_1
        buf406 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_32], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf405, arg264_1, buf406, 1048576, grid=grid(1048576), stream=stream0)
        del arg264_1
        buf407 = reinterpret_tensor(buf405, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf405  # reuse
        # Topologically Sorted Source Nodes: [contiguous_50], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf404, arg262_1, buf407, 1048576, grid=grid(1048576), stream=stream0)
        del arg262_1
        buf408 = buf388; del buf388  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_80], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf407, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf406, (128, 64, 128), (8192, 1, 64), 0), out=buf408)
        buf413 = buf383; del buf383  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_84], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf408, buf413, 16384, 128, grid=grid(16384), stream=stream0)
        buf411 = reinterpret_tensor(buf407, (1024, 1024), (1024, 1), 0); del buf407  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf403, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg265_1, (1024, 1024), (1, 1024), 0), out=buf411)
        del arg265_1
        buf412 = reinterpret_tensor(buf403, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf403  # reuse
        # Topologically Sorted Source Nodes: [value_states_32], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf411, arg266_1, buf412, 1048576, grid=grid(1048576), stream=stream0)
        del arg266_1
        buf414 = reinterpret_tensor(buf411, (128, 128, 64), (8192, 64, 1), 0); del buf411  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_84, attn_output_80], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf413, reinterpret_tensor(buf412, (128, 128, 64), (8192, 64, 1), 0), out=buf414)
        buf415 = reinterpret_tensor(buf404, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf404  # reuse
        # Topologically Sorted Source Nodes: [attn_output_83], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf414, buf415, 1048576, grid=grid(1048576), stream=stream0)
        buf416 = reinterpret_tensor(buf414, (1024, 1024), (1024, 1), 0); del buf414  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf415, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg267_1, (1024, 1024), (1, 1024), 0), out=buf416)
        del arg267_1
        buf417 = reinterpret_tensor(buf416, (8, 128, 1024), (131072, 1024, 1), 0); del buf416  # reuse
        buf421 = reinterpret_tensor(buf415, (8, 128, 1024), (131072, 1024, 1), 0); del buf415  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf417, buf392, buf399, arg258_1, arg268_1, arg269_1, arg270_1, buf421, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg258_1
        del arg268_1
        del arg269_1
        del arg270_1
        buf422 = reinterpret_tensor(buf398, (1024, 4096), (4096, 1), 0); del buf398  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf421, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg271_1, (1024, 4096), (1, 1024), 0), out=buf422)
        del arg271_1
        buf423 = reinterpret_tensor(buf422, (8, 128, 4096), (524288, 4096, 1), 0); del buf422  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_150], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf423, arg272_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg272_1
        buf424 = reinterpret_tensor(buf421, (1024, 1024), (1024, 1), 0); del buf421  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf423, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg273_1, (4096, 1024), (1, 4096), 0), out=buf424)
        del arg273_1
        buf428 = reinterpret_tensor(buf399, (8, 128, 1024), (131072, 1024, 1), 0); del buf399  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_154, hidden_states_155], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf417, buf424, arg274_1, arg275_1, arg276_1, buf428, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg275_1
        del arg276_1
        buf429 = reinterpret_tensor(buf392, (1024, 1024), (1024, 1), 0); del buf392  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf428, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg277_1, (1024, 1024), (1, 1024), 0), out=buf429)
        del arg277_1
        buf430 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf428, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg279_1, (1024, 1024), (1, 1024), 0), out=buf430)
        del arg279_1
        buf431 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_34], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf430, arg280_1, buf431, 1048576, grid=grid(1048576), stream=stream0)
        del arg280_1
        buf432 = reinterpret_tensor(buf430, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf430  # reuse
        # Topologically Sorted Source Nodes: [contiguous_53], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf429, arg278_1, buf432, 1048576, grid=grid(1048576), stream=stream0)
        del arg278_1
        buf433 = buf413; del buf413  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_85], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf432, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf431, (128, 64, 128), (8192, 1, 64), 0), out=buf433)
        buf438 = buf408; del buf408  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_89], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf433, buf438, 16384, 128, grid=grid(16384), stream=stream0)
        buf436 = reinterpret_tensor(buf432, (1024, 1024), (1024, 1), 0); del buf432  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf428, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg281_1, (1024, 1024), (1, 1024), 0), out=buf436)
        del arg281_1
        buf437 = reinterpret_tensor(buf428, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf428  # reuse
        # Topologically Sorted Source Nodes: [value_states_34], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf436, arg282_1, buf437, 1048576, grid=grid(1048576), stream=stream0)
        del arg282_1
        buf439 = reinterpret_tensor(buf436, (128, 128, 64), (8192, 64, 1), 0); del buf436  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_89, attn_output_85], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf438, reinterpret_tensor(buf437, (128, 128, 64), (8192, 64, 1), 0), out=buf439)
        buf440 = reinterpret_tensor(buf429, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf429  # reuse
        # Topologically Sorted Source Nodes: [attn_output_88], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf439, buf440, 1048576, grid=grid(1048576), stream=stream0)
        buf441 = reinterpret_tensor(buf439, (1024, 1024), (1024, 1), 0); del buf439  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf440, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg283_1, (1024, 1024), (1, 1024), 0), out=buf441)
        del arg283_1
        buf442 = reinterpret_tensor(buf441, (8, 128, 1024), (131072, 1024, 1), 0); del buf441  # reuse
        buf446 = reinterpret_tensor(buf440, (8, 128, 1024), (131072, 1024, 1), 0); del buf440  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf442, buf417, buf424, arg274_1, arg284_1, arg285_1, arg286_1, buf446, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg274_1
        del arg284_1
        del arg285_1
        del arg286_1
        buf447 = reinterpret_tensor(buf423, (1024, 4096), (4096, 1), 0); del buf423  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf446, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg287_1, (1024, 4096), (1, 1024), 0), out=buf447)
        del arg287_1
        buf448 = reinterpret_tensor(buf447, (8, 128, 4096), (524288, 4096, 1), 0); del buf447  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_159], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf448, arg288_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg288_1
        buf449 = reinterpret_tensor(buf446, (1024, 1024), (1024, 1), 0); del buf446  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf448, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg289_1, (4096, 1024), (1, 4096), 0), out=buf449)
        del arg289_1
        buf453 = reinterpret_tensor(buf424, (8, 128, 1024), (131072, 1024, 1), 0); del buf424  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_163, hidden_states_164], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf442, buf449, arg290_1, arg291_1, arg292_1, buf453, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg291_1
        del arg292_1
        buf454 = reinterpret_tensor(buf417, (1024, 1024), (1024, 1), 0); del buf417  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf453, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg293_1, (1024, 1024), (1, 1024), 0), out=buf454)
        del arg293_1
        buf455 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf453, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg295_1, (1024, 1024), (1, 1024), 0), out=buf455)
        del arg295_1
        buf456 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_36], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf455, arg296_1, buf456, 1048576, grid=grid(1048576), stream=stream0)
        del arg296_1
        buf457 = reinterpret_tensor(buf455, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf455  # reuse
        # Topologically Sorted Source Nodes: [contiguous_56], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf454, arg294_1, buf457, 1048576, grid=grid(1048576), stream=stream0)
        del arg294_1
        buf458 = buf438; del buf438  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_90], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf457, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf456, (128, 64, 128), (8192, 1, 64), 0), out=buf458)
        buf463 = buf433; del buf433  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_94], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf458, buf463, 16384, 128, grid=grid(16384), stream=stream0)
        buf461 = reinterpret_tensor(buf457, (1024, 1024), (1024, 1), 0); del buf457  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf453, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg297_1, (1024, 1024), (1, 1024), 0), out=buf461)
        del arg297_1
        buf462 = reinterpret_tensor(buf453, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf453  # reuse
        # Topologically Sorted Source Nodes: [value_states_36], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf461, arg298_1, buf462, 1048576, grid=grid(1048576), stream=stream0)
        del arg298_1
        buf464 = reinterpret_tensor(buf461, (128, 128, 64), (8192, 64, 1), 0); del buf461  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_94, attn_output_90], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf463, reinterpret_tensor(buf462, (128, 128, 64), (8192, 64, 1), 0), out=buf464)
        buf465 = reinterpret_tensor(buf454, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf454  # reuse
        # Topologically Sorted Source Nodes: [attn_output_93], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf464, buf465, 1048576, grid=grid(1048576), stream=stream0)
        buf466 = reinterpret_tensor(buf464, (1024, 1024), (1024, 1), 0); del buf464  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf465, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg299_1, (1024, 1024), (1, 1024), 0), out=buf466)
        del arg299_1
        buf467 = reinterpret_tensor(buf466, (8, 128, 1024), (131072, 1024, 1), 0); del buf466  # reuse
        buf471 = reinterpret_tensor(buf465, (8, 128, 1024), (131072, 1024, 1), 0); del buf465  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf467, buf442, buf449, arg290_1, arg300_1, arg301_1, arg302_1, buf471, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg290_1
        del arg300_1
        del arg301_1
        del arg302_1
        buf472 = reinterpret_tensor(buf448, (1024, 4096), (4096, 1), 0); del buf448  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf471, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg303_1, (1024, 4096), (1, 1024), 0), out=buf472)
        del arg303_1
        buf473 = reinterpret_tensor(buf472, (8, 128, 4096), (524288, 4096, 1), 0); del buf472  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_168], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf473, arg304_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg304_1
        buf474 = reinterpret_tensor(buf471, (1024, 1024), (1024, 1), 0); del buf471  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf473, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg305_1, (4096, 1024), (1, 4096), 0), out=buf474)
        del arg305_1
        buf478 = reinterpret_tensor(buf449, (8, 128, 1024), (131072, 1024, 1), 0); del buf449  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_172, hidden_states_173], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf467, buf474, arg306_1, arg307_1, arg308_1, buf478, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg307_1
        del arg308_1
        buf479 = reinterpret_tensor(buf442, (1024, 1024), (1024, 1), 0); del buf442  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf478, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg309_1, (1024, 1024), (1, 1024), 0), out=buf479)
        del arg309_1
        buf480 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf478, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg311_1, (1024, 1024), (1, 1024), 0), out=buf480)
        del arg311_1
        buf481 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_38], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf480, arg312_1, buf481, 1048576, grid=grid(1048576), stream=stream0)
        del arg312_1
        buf482 = reinterpret_tensor(buf480, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf480  # reuse
        # Topologically Sorted Source Nodes: [contiguous_59], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf479, arg310_1, buf482, 1048576, grid=grid(1048576), stream=stream0)
        del arg310_1
        buf483 = buf463; del buf463  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_95], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf482, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf481, (128, 64, 128), (8192, 1, 64), 0), out=buf483)
        buf488 = buf458; del buf458  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_99], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf483, buf488, 16384, 128, grid=grid(16384), stream=stream0)
        buf486 = reinterpret_tensor(buf482, (1024, 1024), (1024, 1), 0); del buf482  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf478, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg313_1, (1024, 1024), (1, 1024), 0), out=buf486)
        del arg313_1
        buf487 = reinterpret_tensor(buf478, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf478  # reuse
        # Topologically Sorted Source Nodes: [value_states_38], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf486, arg314_1, buf487, 1048576, grid=grid(1048576), stream=stream0)
        del arg314_1
        buf489 = reinterpret_tensor(buf486, (128, 128, 64), (8192, 64, 1), 0); del buf486  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_99, attn_output_95], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf488, reinterpret_tensor(buf487, (128, 128, 64), (8192, 64, 1), 0), out=buf489)
        buf490 = reinterpret_tensor(buf479, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf479  # reuse
        # Topologically Sorted Source Nodes: [attn_output_98], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf489, buf490, 1048576, grid=grid(1048576), stream=stream0)
        buf491 = reinterpret_tensor(buf489, (1024, 1024), (1024, 1), 0); del buf489  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf490, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg315_1, (1024, 1024), (1, 1024), 0), out=buf491)
        del arg315_1
        buf492 = reinterpret_tensor(buf491, (8, 128, 1024), (131072, 1024, 1), 0); del buf491  # reuse
        buf496 = reinterpret_tensor(buf490, (8, 128, 1024), (131072, 1024, 1), 0); del buf490  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf492, buf467, buf474, arg306_1, arg316_1, arg317_1, arg318_1, buf496, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg306_1
        del arg316_1
        del arg317_1
        del arg318_1
        buf497 = reinterpret_tensor(buf473, (1024, 4096), (4096, 1), 0); del buf473  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf496, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg319_1, (1024, 4096), (1, 1024), 0), out=buf497)
        del arg319_1
        buf498 = reinterpret_tensor(buf497, (8, 128, 4096), (524288, 4096, 1), 0); del buf497  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_177], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf498, arg320_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg320_1
        buf499 = reinterpret_tensor(buf496, (1024, 1024), (1024, 1), 0); del buf496  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf498, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg321_1, (4096, 1024), (1, 4096), 0), out=buf499)
        del arg321_1
        buf503 = reinterpret_tensor(buf474, (8, 128, 1024), (131072, 1024, 1), 0); del buf474  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_181, hidden_states_182], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf492, buf499, arg322_1, arg323_1, arg324_1, buf503, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg323_1
        del arg324_1
        buf504 = reinterpret_tensor(buf467, (1024, 1024), (1024, 1), 0); del buf467  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf503, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg325_1, (1024, 1024), (1, 1024), 0), out=buf504)
        del arg325_1
        buf505 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf503, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg327_1, (1024, 1024), (1, 1024), 0), out=buf505)
        del arg327_1
        buf506 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_40], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf505, arg328_1, buf506, 1048576, grid=grid(1048576), stream=stream0)
        del arg328_1
        buf507 = reinterpret_tensor(buf505, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf505  # reuse
        # Topologically Sorted Source Nodes: [contiguous_62], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf504, arg326_1, buf507, 1048576, grid=grid(1048576), stream=stream0)
        del arg326_1
        buf508 = buf488; del buf488  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_100], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf507, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf506, (128, 64, 128), (8192, 1, 64), 0), out=buf508)
        buf513 = buf483; del buf483  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_104], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf508, buf513, 16384, 128, grid=grid(16384), stream=stream0)
        buf511 = reinterpret_tensor(buf507, (1024, 1024), (1024, 1), 0); del buf507  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf503, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg329_1, (1024, 1024), (1, 1024), 0), out=buf511)
        del arg329_1
        buf512 = reinterpret_tensor(buf503, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf503  # reuse
        # Topologically Sorted Source Nodes: [value_states_40], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf511, arg330_1, buf512, 1048576, grid=grid(1048576), stream=stream0)
        del arg330_1
        buf514 = reinterpret_tensor(buf511, (128, 128, 64), (8192, 64, 1), 0); del buf511  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_104, attn_output_100], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf513, reinterpret_tensor(buf512, (128, 128, 64), (8192, 64, 1), 0), out=buf514)
        buf515 = reinterpret_tensor(buf504, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf504  # reuse
        # Topologically Sorted Source Nodes: [attn_output_103], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf514, buf515, 1048576, grid=grid(1048576), stream=stream0)
        buf516 = reinterpret_tensor(buf514, (1024, 1024), (1024, 1), 0); del buf514  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf515, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg331_1, (1024, 1024), (1, 1024), 0), out=buf516)
        del arg331_1
        buf517 = reinterpret_tensor(buf516, (8, 128, 1024), (131072, 1024, 1), 0); del buf516  # reuse
        buf521 = reinterpret_tensor(buf515, (8, 128, 1024), (131072, 1024, 1), 0); del buf515  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf517, buf492, buf499, arg322_1, arg332_1, arg333_1, arg334_1, buf521, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg322_1
        del arg332_1
        del arg333_1
        del arg334_1
        buf522 = reinterpret_tensor(buf498, (1024, 4096), (4096, 1), 0); del buf498  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf521, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg335_1, (1024, 4096), (1, 1024), 0), out=buf522)
        del arg335_1
        buf523 = reinterpret_tensor(buf522, (8, 128, 4096), (524288, 4096, 1), 0); del buf522  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_186], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf523, arg336_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg336_1
        buf524 = reinterpret_tensor(buf521, (1024, 1024), (1024, 1), 0); del buf521  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf523, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg337_1, (4096, 1024), (1, 4096), 0), out=buf524)
        del arg337_1
        buf528 = reinterpret_tensor(buf499, (8, 128, 1024), (131072, 1024, 1), 0); del buf499  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_190, hidden_states_191], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf517, buf524, arg338_1, arg339_1, arg340_1, buf528, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg339_1
        del arg340_1
        buf529 = reinterpret_tensor(buf492, (1024, 1024), (1024, 1), 0); del buf492  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf528, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg341_1, (1024, 1024), (1, 1024), 0), out=buf529)
        del arg341_1
        buf530 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf528, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg343_1, (1024, 1024), (1, 1024), 0), out=buf530)
        del arg343_1
        buf531 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_42], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf530, arg344_1, buf531, 1048576, grid=grid(1048576), stream=stream0)
        del arg344_1
        buf532 = reinterpret_tensor(buf530, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf530  # reuse
        # Topologically Sorted Source Nodes: [contiguous_65], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf529, arg342_1, buf532, 1048576, grid=grid(1048576), stream=stream0)
        del arg342_1
        buf533 = buf513; del buf513  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_105], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf532, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf531, (128, 64, 128), (8192, 1, 64), 0), out=buf533)
        buf538 = buf508; del buf508  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_109], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf533, buf538, 16384, 128, grid=grid(16384), stream=stream0)
        buf536 = reinterpret_tensor(buf532, (1024, 1024), (1024, 1), 0); del buf532  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf528, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg345_1, (1024, 1024), (1, 1024), 0), out=buf536)
        del arg345_1
        buf537 = reinterpret_tensor(buf528, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf528  # reuse
        # Topologically Sorted Source Nodes: [value_states_42], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf536, arg346_1, buf537, 1048576, grid=grid(1048576), stream=stream0)
        del arg346_1
        buf539 = reinterpret_tensor(buf536, (128, 128, 64), (8192, 64, 1), 0); del buf536  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_109, attn_output_105], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf538, reinterpret_tensor(buf537, (128, 128, 64), (8192, 64, 1), 0), out=buf539)
        buf540 = reinterpret_tensor(buf529, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf529  # reuse
        # Topologically Sorted Source Nodes: [attn_output_108], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf539, buf540, 1048576, grid=grid(1048576), stream=stream0)
        buf541 = reinterpret_tensor(buf539, (1024, 1024), (1024, 1), 0); del buf539  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf540, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg347_1, (1024, 1024), (1, 1024), 0), out=buf541)
        del arg347_1
        buf542 = reinterpret_tensor(buf541, (8, 128, 1024), (131072, 1024, 1), 0); del buf541  # reuse
        buf546 = reinterpret_tensor(buf540, (8, 128, 1024), (131072, 1024, 1), 0); del buf540  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf542, buf517, buf524, arg338_1, arg348_1, arg349_1, arg350_1, buf546, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg338_1
        del arg348_1
        del arg349_1
        del arg350_1
        buf547 = reinterpret_tensor(buf523, (1024, 4096), (4096, 1), 0); del buf523  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf546, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg351_1, (1024, 4096), (1, 1024), 0), out=buf547)
        del arg351_1
        buf548 = reinterpret_tensor(buf547, (8, 128, 4096), (524288, 4096, 1), 0); del buf547  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_195], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf548, arg352_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg352_1
        buf549 = reinterpret_tensor(buf546, (1024, 1024), (1024, 1), 0); del buf546  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf548, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg353_1, (4096, 1024), (1, 4096), 0), out=buf549)
        del arg353_1
        buf553 = reinterpret_tensor(buf524, (8, 128, 1024), (131072, 1024, 1), 0); del buf524  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_199, hidden_states_200], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf542, buf549, arg354_1, arg355_1, arg356_1, buf553, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg355_1
        del arg356_1
        buf554 = reinterpret_tensor(buf517, (1024, 1024), (1024, 1), 0); del buf517  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf553, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg357_1, (1024, 1024), (1, 1024), 0), out=buf554)
        del arg357_1
        buf555 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf553, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg359_1, (1024, 1024), (1, 1024), 0), out=buf555)
        del arg359_1
        buf556 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_44], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf555, arg360_1, buf556, 1048576, grid=grid(1048576), stream=stream0)
        del arg360_1
        buf557 = reinterpret_tensor(buf555, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf555  # reuse
        # Topologically Sorted Source Nodes: [contiguous_68], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf554, arg358_1, buf557, 1048576, grid=grid(1048576), stream=stream0)
        del arg358_1
        buf558 = buf538; del buf538  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_110], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf557, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf556, (128, 64, 128), (8192, 1, 64), 0), out=buf558)
        buf563 = buf533; del buf533  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_114], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf558, buf563, 16384, 128, grid=grid(16384), stream=stream0)
        buf561 = reinterpret_tensor(buf557, (1024, 1024), (1024, 1), 0); del buf557  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf553, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg361_1, (1024, 1024), (1, 1024), 0), out=buf561)
        del arg361_1
        buf562 = reinterpret_tensor(buf553, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf553  # reuse
        # Topologically Sorted Source Nodes: [value_states_44], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf561, arg362_1, buf562, 1048576, grid=grid(1048576), stream=stream0)
        del arg362_1
        buf564 = reinterpret_tensor(buf561, (128, 128, 64), (8192, 64, 1), 0); del buf561  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_114, attn_output_110], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf563, reinterpret_tensor(buf562, (128, 128, 64), (8192, 64, 1), 0), out=buf564)
        buf565 = reinterpret_tensor(buf554, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf554  # reuse
        # Topologically Sorted Source Nodes: [attn_output_113], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf564, buf565, 1048576, grid=grid(1048576), stream=stream0)
        buf566 = reinterpret_tensor(buf564, (1024, 1024), (1024, 1), 0); del buf564  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf565, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg363_1, (1024, 1024), (1, 1024), 0), out=buf566)
        del arg363_1
        buf567 = reinterpret_tensor(buf566, (8, 128, 1024), (131072, 1024, 1), 0); del buf566  # reuse
        buf571 = reinterpret_tensor(buf565, (8, 128, 1024), (131072, 1024, 1), 0); del buf565  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf567, buf542, buf549, arg354_1, arg364_1, arg365_1, arg366_1, buf571, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg354_1
        del arg364_1
        del arg365_1
        del arg366_1
        buf572 = reinterpret_tensor(buf548, (1024, 4096), (4096, 1), 0); del buf548  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf571, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg367_1, (1024, 4096), (1, 1024), 0), out=buf572)
        del arg367_1
        buf573 = reinterpret_tensor(buf572, (8, 128, 4096), (524288, 4096, 1), 0); del buf572  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_204], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf573, arg368_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg368_1
        buf574 = reinterpret_tensor(buf571, (1024, 1024), (1024, 1), 0); del buf571  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf573, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg369_1, (4096, 1024), (1, 4096), 0), out=buf574)
        del arg369_1
        buf578 = reinterpret_tensor(buf549, (8, 128, 1024), (131072, 1024, 1), 0); del buf549  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_208, hidden_states_209], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf567, buf574, arg370_1, arg371_1, arg372_1, buf578, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg371_1
        del arg372_1
        buf579 = reinterpret_tensor(buf542, (1024, 1024), (1024, 1), 0); del buf542  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf578, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg373_1, (1024, 1024), (1, 1024), 0), out=buf579)
        del arg373_1
        buf580 = empty_strided_cuda((1024, 1024), (1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf578, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg375_1, (1024, 1024), (1, 1024), 0), out=buf580)
        del arg375_1
        buf581 = empty_strided_cuda((8, 16, 128, 64), (131072, 8192, 64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [key_states_46], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf580, arg376_1, buf581, 1048576, grid=grid(1048576), stream=stream0)
        del arg376_1
        buf582 = reinterpret_tensor(buf580, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf580  # reuse
        # Topologically Sorted Source Nodes: [contiguous_71], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf579, arg374_1, buf582, 1048576, grid=grid(1048576), stream=stream0)
        del arg374_1
        buf583 = buf563; del buf563  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_115], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf582, (128, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf581, (128, 64, 128), (8192, 1, 64), 0), out=buf583)
        buf588 = buf558; del buf558  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_119], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf583, buf588, 16384, 128, grid=grid(16384), stream=stream0)
        del buf583
        buf586 = reinterpret_tensor(buf582, (1024, 1024), (1024, 1), 0); del buf582  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf578, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg377_1, (1024, 1024), (1, 1024), 0), out=buf586)
        del arg377_1
        buf587 = reinterpret_tensor(buf578, (8, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf578  # reuse
        # Topologically Sorted Source Nodes: [value_states_46], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf586, arg378_1, buf587, 1048576, grid=grid(1048576), stream=stream0)
        del arg378_1
        buf589 = reinterpret_tensor(buf586, (128, 128, 64), (8192, 64, 1), 0); del buf586  # reuse
        # Topologically Sorted Source Nodes: [attn_weights_119, attn_output_115], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf588, reinterpret_tensor(buf587, (128, 128, 64), (8192, 64, 1), 0), out=buf589)
        del buf588
        buf590 = reinterpret_tensor(buf579, (8, 128, 16, 64), (131072, 1024, 64, 1), 0); del buf579  # reuse
        # Topologically Sorted Source Nodes: [attn_output_118], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf589, buf590, 1048576, grid=grid(1048576), stream=stream0)
        buf591 = reinterpret_tensor(buf589, (1024, 1024), (1024, 1), 0); del buf589  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf590, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg379_1, (1024, 1024), (1, 1024), 0), out=buf591)
        del arg379_1
        buf592 = reinterpret_tensor(buf591, (8, 128, 1024), (131072, 1024, 1), 0); del buf591  # reuse
        buf596 = reinterpret_tensor(buf590, (8, 128, 1024), (131072, 1024, 1), 0); del buf590  # reuse
        ...
        triton_per_fused_add_native_layer_norm_8.run(buf592, buf567, buf574, arg370_1, arg380_1, arg381_1, arg382_1, buf596, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg370_1
        del arg380_1
        del arg381_1
        del arg382_1
        del buf567
        buf597 = reinterpret_tensor(buf573, (1024, 4096), (4096, 1), 0); del buf573  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf596, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg383_1, (1024, 4096), (1, 1024), 0), out=buf597)
        del arg383_1
        buf598 = reinterpret_tensor(buf597, (8, 128, 4096), (524288, 4096, 1), 0); del buf597  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_213], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf598, arg384_1, 4194304, grid=grid(4194304), stream=stream0)
        del arg384_1
        buf599 = reinterpret_tensor(buf596, (1024, 1024), (1024, 1), 0); del buf596  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf598, (1024, 4096), (4096, 1), 0), reinterpret_tensor(arg385_1, (4096, 1024), (1, 4096), 0), out=buf599)
        del arg385_1
        del buf598
        buf603 = reinterpret_tensor(buf574, (8, 128, 1024), (131072, 1024, 1), 0); del buf574  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_217, hidden_states_218], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf592, buf599, arg386_1, arg387_1, arg388_1, buf603, 1024, 1024, grid=grid(1024), stream=stream0)
        del arg386_1
        del arg387_1
        del arg388_1
        del buf592
        del buf599
        buf604 = empty_strided_cuda((1024, 256008), (256032, 1), torch.float32)
        # Topologically Sorted Source Nodes: [logits], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf603, (1024, 1024), (1024, 1), 0), reinterpret_tensor(arg1_1, (1024, 256008), (1, 1024), 0), out=buf604)
        del arg1_1
        del buf603
        buf605 = empty_strided_cuda((1024, 1), (1, 1024), torch.float32)
        buf606 = empty_strided_cuda((1024, 1), (1, 1024), torch.float32)
        # Topologically Sorted Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_9.run(buf604, buf605, buf606, 1024, 256008, grid=grid(1024), stream=stream0)
        buf607 = empty_strided_cuda((), (), torch.float32)
        buf609 = buf607; del buf607  # reuse
        # Topologically Sorted Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_10.run(buf609, arg389_1, buf604, buf605, buf606, 1, 1024, grid=grid(1), stream=stream0)
        del arg389_1
        del buf605
        del buf606
    return (buf609, reinterpret_tensor(buf604, (8, 128, 256008), (32772096, 256032, 1), 0), buf6, buf12, buf31, buf37, buf56, buf62, buf81, buf87, buf106, buf112, buf131, buf137, buf156, buf162, buf181, buf187, buf206, buf212, buf231, buf237, buf256, buf262, buf281, buf287, buf306, buf312, buf331, buf337, buf356, buf362, buf381, buf387, buf406, buf412, buf431, buf437, buf456, buf462, buf481, buf487, buf506, buf512, buf531, buf537, buf556, buf562, buf581, buf587, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((256008, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((2050, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg389_1 = rand_strided((8, 128), (128, 1), device='cuda:0', dtype=torch.int64)
