...
# kernel path: /tmp/torchinductor_sahanp/yi/cyip4inbj4woyy4og5awgto45xyybwh2f53xg2vdtcfbrbli7zw2.py
...
# kernel path: /tmp/torchinductor_sahanp/yh/cyhwfw3xwtfrlsn2wfuwkuu4eueq5tzoxcjxa4jypzwlpafvytdl.py
...
# kernel path: /tmp/torchinductor_sahanp/zg/czgxeqvz53rdizjqhaszoxuxz5jmjrdsnwvmz7azpnp3ssgtxvw3.py
...
# kernel path: /tmp/torchinductor_sahanp/5y/c5ytzo76wal2uejlfoqryc27hmockf24t74fg4yhhfmhrc5eszk7.py
...
# kernel path: /tmp/torchinductor_sahanp/wj/cwj54dug2izy2dz2amkqxkx4d54cb56h6wpl4rfx6fx5r4x7v5rg.py
...
# kernel path: /tmp/torchinductor_sahanp/ci/ccir5uagjozzl4n7k3m6w76rye2nmvp7hnbfgyigafw3ckv5wcb6.py
# Topologically Sorted Source Nodes: [eq, int_1, argmax], Original ATen: [aten.eq, aten._to_copy, aten.argmax]
# Source node to ATen node mapping:
#   argmax => argmax
#   eq => eq
...
#   %convert_element_type : [num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%eq, torch.int32), kwargs = {})
#   %argmax : [num_users=1] = call_function[target=torch.ops.aten.argmax.default](args = (%convert_element_type, -1), kwargs = {})
triton_per_fused__to_copy_argmax_eq_6 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from triton.compiler.compiler import AttrsDescriptor
...
# kernel path: /tmp/torchinductor_sahanp/id/cidxddwfvszs4nhwtktkzyver37kdhkclw44x45xriibiycphrst.py
# Topologically Sorted Source Nodes: [pooled_logits], Original ATen: [aten.index]
# Source node to ATen node mapping:
#   pooled_logits => index
# Graph fragment:
#   %index : [num_users=2] = call_function[target=torch.ops.aten.index.Tensor](args = (%view_148, [%iota_2, %remainder]), kwargs = {})
...
# kernel path: /tmp/torchinductor_sahanp/wv/cwvjrnocwofa7cog5d7rskc5ghtlj4q3kcgdj6bg2wlk3jxrsnyy.py
# Topologically Sorted Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
# Source node to ATen node mapping:
#   loss => convert_element_type_1, div, full_default_3, ne_1, ne_2, neg, sum_2, sum_3, where_2
# Graph fragment:
#   %ne_1 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%view_150, -100), kwargs = {})
...
#   %ne_2 : [num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%view_150, -100), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg149_1, (2, 768), (768, 1))
    assert_size_stride(arg150_1, (4, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf3 = empty_strided_cuda((4, 1024, 768), (786432, 768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [inputs_embeds, position_embeds, add, hidden_states], Original ATen: [aten.embedding, aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_red_fused_add_embedding_native_layer_norm_0.run(arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, buf3, 4096, 768, grid=grid(4096), stream=stream0)
        del arg3_1
        del arg4_1
        buf4 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg5_1, reinterpret_tensor(buf3, (4096, 768), (768, 1), 0), arg6_1, alpha=1, beta=1, out=buf4)
        del arg5_1
        del arg6_1
        buf5 = empty_strided_cuda((4, 12, 1024, 1024), (12582912, 1048576, 1024, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_output], Original ATen: [aten._scaled_dot_product_efficient_attention]
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf5, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf6 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf4, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf4, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf4, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf5, False)
        buf7 = buf6[0]
        del buf6
        buf11 = reinterpret_tensor(buf3, (4096, 768), (768, 1), 0); del buf3  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf7, (4096, 768), (768, 1), 0), arg8_1, out=buf11)
        del arg8_1
        buf12 = reinterpret_tensor(buf11, (4, 1024, 768), (786432, 768, 1), 0); del buf11  # reuse
        buf16 = reinterpret_tensor(buf7, (4, 1024, 768), (786432, 768, 1), 0); del buf7  # reuse
        # Topologically Sorted Source Nodes: [inputs_embeds, position_embeds, add, hidden_states_1, hidden_states_2], Original ATen: [aten.embedding, aten.add, aten.native_layer_norm]
        triton_per_fused_add_embedding_native_layer_norm_2.run(buf12, arg7_1, arg0_1, arg1_1, arg2_1, arg9_1, arg10_1, buf16, 4096, 768, grid=grid(4096), stream=stream0)
        del arg10_1
        del arg1_1
        del arg2_1
        del arg7_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf16, (4096, 768), (768, 1), 0), arg12_1, out=buf17)
        del arg12_1
        buf18 = reinterpret_tensor(buf17, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [mul, pow_1, mul_1, add_3, mul_2, tanh, add_4, hidden_states_3], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf18, arg11_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg11_1
        buf19 = reinterpret_tensor(buf16, (4096, 768), (768, 1), 0); del buf16  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf18, (4096, 3072), (3072, 1), 0), arg14_1, out=buf19)
        del arg14_1
        buf23 = empty_strided_cuda((4, 1024, 768), (786432, 768, 1), torch.float32)
        # Topologically Sorted Source Nodes: [hidden_states_5, hidden_states_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf12, buf19, arg13_1, arg15_1, arg16_1, buf23, 4096, 768, grid=grid(4096), stream=stream0)
        del arg15_1
        del arg16_1
        buf24 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_8], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg17_1, reinterpret_tensor(buf23, (4096, 768), (768, 1), 0), arg18_1, alpha=1, beta=1, out=buf24)
        del arg17_1
        del arg18_1
        ...
        # Topologically Sorted Source Nodes: [attn_output_4], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf26 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf24, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf24, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf24, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf25, False)
        buf27 = buf26[0]
        del buf26
        buf31 = reinterpret_tensor(buf23, (4096, 768), (768, 1), 0); del buf23  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (4096, 768), (768, 1), 0), arg20_1, out=buf31)
        del arg20_1
        buf32 = reinterpret_tensor(buf31, (4, 1024, 768), (786432, 768, 1), 0); del buf31  # reuse
        buf36 = reinterpret_tensor(buf27, (4, 1024, 768), (786432, 768, 1), 0); del buf27  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_5, hidden_states_7, hidden_states_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf32, arg19_1, buf12, buf19, arg13_1, arg21_1, arg22_1, buf36, 4096, 768, grid=grid(4096), stream=stream0)
        del arg13_1
        del arg19_1
        del arg21_1
        del arg22_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf36, (4096, 768), (768, 1), 0), arg24_1, out=buf37)
        del arg24_1
        buf38 = reinterpret_tensor(buf37, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf37  # reuse
        ...
        triton_poi_fused_add_mul_pow_tanh_3.run(buf38, arg23_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg23_1
        buf39 = reinterpret_tensor(buf36, (4096, 768), (768, 1), 0); del buf36  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf38, (4096, 3072), (3072, 1), 0), arg26_1, out=buf39)
        del arg26_1
        buf43 = reinterpret_tensor(buf19, (4, 1024, 768), (786432, 768, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_11, hidden_states_12], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf32, buf39, arg25_1, arg27_1, arg28_1, buf43, 4096, 768, grid=grid(4096), stream=stream0)
        del arg27_1
        del arg28_1
        buf44 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_16], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg29_1, reinterpret_tensor(buf43, (4096, 768), (768, 1), 0), arg30_1, alpha=1, beta=1, out=buf44)
        del arg29_1
        del arg30_1
        ...
        # Topologically Sorted Source Nodes: [attn_output_8], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf46 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf44, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf44, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf44, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf45, False)
        buf47 = buf46[0]
        del buf46
        buf51 = reinterpret_tensor(buf43, (4096, 768), (768, 1), 0); del buf43  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf47, (4096, 768), (768, 1), 0), arg32_1, out=buf51)
        del arg32_1
        buf52 = reinterpret_tensor(buf51, (4, 1024, 768), (786432, 768, 1), 0); del buf51  # reuse
        buf56 = reinterpret_tensor(buf47, (4, 1024, 768), (786432, 768, 1), 0); del buf47  # reuse
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf52, arg31_1, buf32, buf39, arg25_1, arg33_1, arg34_1, buf56, 4096, 768, grid=grid(4096), stream=stream0)
        del arg25_1
        del arg31_1
        del arg33_1
        del arg34_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf56, (4096, 768), (768, 1), 0), arg36_1, out=buf57)
        del arg36_1
        buf58 = reinterpret_tensor(buf57, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf57  # reuse
        ...
        triton_poi_fused_add_mul_pow_tanh_3.run(buf58, arg35_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg35_1
        buf59 = reinterpret_tensor(buf56, (4096, 768), (768, 1), 0); del buf56  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf58, (4096, 3072), (3072, 1), 0), arg38_1, out=buf59)
        del arg38_1
        buf63 = reinterpret_tensor(buf39, (4, 1024, 768), (786432, 768, 1), 0); del buf39  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_17, hidden_states_18], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf52, buf59, arg37_1, arg39_1, arg40_1, buf63, 4096, 768, grid=grid(4096), stream=stream0)
        del arg39_1
        del arg40_1
        buf64 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_24], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg41_1, reinterpret_tensor(buf63, (4096, 768), (768, 1), 0), arg42_1, alpha=1, beta=1, out=buf64)
        del arg41_1
        del arg42_1
        ...
        # Topologically Sorted Source Nodes: [attn_output_12], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf66 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf64, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf64, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf64, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf65, False)
        buf67 = buf66[0]
        del buf66
        buf71 = reinterpret_tensor(buf63, (4096, 768), (768, 1), 0); del buf63  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (4096, 768), (768, 1), 0), arg44_1, out=buf71)
        del arg44_1
        buf72 = reinterpret_tensor(buf71, (4, 1024, 768), (786432, 768, 1), 0); del buf71  # reuse
        buf76 = reinterpret_tensor(buf67, (4, 1024, 768), (786432, 768, 1), 0); del buf67  # reuse
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf72, arg43_1, buf52, buf59, arg37_1, arg45_1, arg46_1, buf76, 4096, 768, grid=grid(4096), stream=stream0)
        del arg37_1
        del arg43_1
        del arg45_1
        del arg46_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (4096, 768), (768, 1), 0), arg48_1, out=buf77)
        del arg48_1
        buf78 = reinterpret_tensor(buf77, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf77  # reuse
        ...
        triton_poi_fused_add_mul_pow_tanh_3.run(buf78, arg47_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg47_1
        buf79 = reinterpret_tensor(buf76, (4096, 768), (768, 1), 0); del buf76  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (4096, 3072), (3072, 1), 0), arg50_1, out=buf79)
        del arg50_1
        buf83 = reinterpret_tensor(buf59, (4, 1024, 768), (786432, 768, 1), 0); del buf59  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_23, hidden_states_24], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf72, buf79, arg49_1, arg51_1, arg52_1, buf83, 4096, 768, grid=grid(4096), stream=stream0)
        del arg51_1
        del arg52_1
        buf84 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_32], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg53_1, reinterpret_tensor(buf83, (4096, 768), (768, 1), 0), arg54_1, alpha=1, beta=1, out=buf84)
        del arg53_1
        del arg54_1
        ...
        # Topologically Sorted Source Nodes: [attn_output_16], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf86 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf84, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf84, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf84, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf85, False)
        buf87 = buf86[0]
        del buf86
        buf91 = reinterpret_tensor(buf83, (4096, 768), (768, 1), 0); del buf83  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf87, (4096, 768), (768, 1), 0), arg56_1, out=buf91)
        del arg56_1
        buf92 = reinterpret_tensor(buf91, (4, 1024, 768), (786432, 768, 1), 0); del buf91  # reuse
        buf96 = reinterpret_tensor(buf87, (4, 1024, 768), (786432, 768, 1), 0); del buf87  # reuse
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf92, arg55_1, buf72, buf79, arg49_1, arg57_1, arg58_1, buf96, 4096, 768, grid=grid(4096), stream=stream0)
        del arg49_1
        del arg55_1
        del arg57_1
        del arg58_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (4096, 768), (768, 1), 0), arg60_1, out=buf97)
        del arg60_1
        buf98 = reinterpret_tensor(buf97, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf97  # reuse
        ...
        triton_poi_fused_add_mul_pow_tanh_3.run(buf98, arg59_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg59_1
        buf99 = reinterpret_tensor(buf96, (4096, 768), (768, 1), 0); del buf96  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf98, (4096, 3072), (3072, 1), 0), arg62_1, out=buf99)
        del arg62_1
        buf103 = reinterpret_tensor(buf79, (4, 1024, 768), (786432, 768, 1), 0); del buf79  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_29, hidden_states_30], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf92, buf99, arg61_1, arg63_1, arg64_1, buf103, 4096, 768, grid=grid(4096), stream=stream0)
        del arg63_1
        del arg64_1
        buf104 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_40], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg65_1, reinterpret_tensor(buf103, (4096, 768), (768, 1), 0), arg66_1, alpha=1, beta=1, out=buf104)
        del arg65_1
        del arg66_1
        ...
        # Topologically Sorted Source Nodes: [attn_output_20], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf106 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf104, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf104, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf104, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf105, False)
        buf107 = buf106[0]
        del buf106
        buf111 = reinterpret_tensor(buf103, (4096, 768), (768, 1), 0); del buf103  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf107, (4096, 768), (768, 1), 0), arg68_1, out=buf111)
        del arg68_1
        buf112 = reinterpret_tensor(buf111, (4, 1024, 768), (786432, 768, 1), 0); del buf111  # reuse
        buf116 = reinterpret_tensor(buf107, (4, 1024, 768), (786432, 768, 1), 0); del buf107  # reuse
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf112, arg67_1, buf92, buf99, arg61_1, arg69_1, arg70_1, buf116, 4096, 768, grid=grid(4096), stream=stream0)
        del arg61_1
        del arg67_1
        del arg69_1
        del arg70_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (4096, 768), (768, 1), 0), arg72_1, out=buf117)
        del arg72_1
        ...
        triton_poi_fused_add_mul_pow_tanh_3.run(buf118, arg71_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg71_1
        buf119 = reinterpret_tensor(buf116, (4096, 768), (768, 1), 0); del buf116  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (4096, 3072), (3072, 1), 0), arg74_1, out=buf119)
        del arg74_1
        buf123 = reinterpret_tensor(buf99, (4, 1024, 768), (786432, 768, 1), 0); del buf99  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_35, hidden_states_36], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf112, buf119, arg73_1, arg75_1, arg76_1, buf123, 4096, 768, grid=grid(4096), stream=stream0)
        del arg75_1
        del arg76_1
        buf124 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_48], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg77_1, reinterpret_tensor(buf123, (4096, 768), (768, 1), 0), arg78_1, alpha=1, beta=1, out=buf124)
        del arg77_1
        del arg78_1
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf125, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output_24], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf126 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf124, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf124, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf124, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf125, False)
        buf127 = buf126[0]
        del buf126
        buf131 = reinterpret_tensor(buf123, (4096, 768), (768, 1), 0); del buf123  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf127, (4096, 768), (768, 1), 0), arg80_1, out=buf131)
        del arg80_1
        buf132 = reinterpret_tensor(buf131, (4, 1024, 768), (786432, 768, 1), 0); del buf131  # reuse
        buf136 = reinterpret_tensor(buf127, (4, 1024, 768), (786432, 768, 1), 0); del buf127  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_35, hidden_states_37, hidden_states_38], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf132, arg79_1, buf112, buf119, arg73_1, arg81_1, arg82_1, buf136, 4096, 768, grid=grid(4096), stream=stream0)
        del arg73_1
        del arg79_1
        del arg81_1
        del arg82_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf136, (4096, 768), (768, 1), 0), arg84_1, out=buf137)
        del arg84_1
        buf138 = reinterpret_tensor(buf137, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf137  # reuse
        # Topologically Sorted Source Nodes: [mul_24, pow_7, mul_25, add_27, mul_26, tanh_6, add_28, hidden_states_39], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf138, arg83_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg83_1
        buf139 = reinterpret_tensor(buf136, (4096, 768), (768, 1), 0); del buf136  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf138, (4096, 3072), (3072, 1), 0), arg86_1, out=buf139)
        del arg86_1
        buf143 = reinterpret_tensor(buf119, (4, 1024, 768), (786432, 768, 1), 0); del buf119  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_41, hidden_states_42], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf132, buf139, arg85_1, arg87_1, arg88_1, buf143, 4096, 768, grid=grid(4096), stream=stream0)
        del arg87_1
        del arg88_1
        buf144 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_56], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg89_1, reinterpret_tensor(buf143, (4096, 768), (768, 1), 0), arg90_1, alpha=1, beta=1, out=buf144)
        del arg89_1
        del arg90_1
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf145, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output_28], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf146 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf144, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf144, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf144, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf145, False)
        buf147 = buf146[0]
        del buf146
        buf151 = reinterpret_tensor(buf143, (4096, 768), (768, 1), 0); del buf143  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (4096, 768), (768, 1), 0), arg92_1, out=buf151)
        del arg92_1
        buf152 = reinterpret_tensor(buf151, (4, 1024, 768), (786432, 768, 1), 0); del buf151  # reuse
        buf156 = reinterpret_tensor(buf147, (4, 1024, 768), (786432, 768, 1), 0); del buf147  # reuse
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf152, arg91_1, buf132, buf139, arg85_1, arg93_1, arg94_1, buf156, 4096, 768, grid=grid(4096), stream=stream0)
        del arg85_1
        del arg91_1
        del arg93_1
        del arg94_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf156, (4096, 768), (768, 1), 0), arg96_1, out=buf157)
        del arg96_1
        buf158 = reinterpret_tensor(buf157, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf157  # reuse
        # Topologically Sorted Source Nodes: [mul_28, pow_8, mul_29, add_31, mul_30, tanh_7, add_32, hidden_states_45], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf158, arg95_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg95_1
        buf159 = reinterpret_tensor(buf156, (4096, 768), (768, 1), 0); del buf156  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (4096, 3072), (3072, 1), 0), arg98_1, out=buf159)
        del arg98_1
        buf163 = reinterpret_tensor(buf139, (4, 1024, 768), (786432, 768, 1), 0); del buf139  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_47, hidden_states_48], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf152, buf159, arg97_1, arg99_1, arg100_1, buf163, 4096, 768, grid=grid(4096), stream=stream0)
        del arg100_1
        del arg99_1
        buf164 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_64], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg101_1, reinterpret_tensor(buf163, (4096, 768), (768, 1), 0), arg102_1, alpha=1, beta=1, out=buf164)
        del arg101_1
        del arg102_1
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf165, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output_32], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf166 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf164, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf164, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf164, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf165, False)
        buf167 = buf166[0]
        del buf166
        buf171 = reinterpret_tensor(buf163, (4096, 768), (768, 1), 0); del buf163  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf167, (4096, 768), (768, 1), 0), arg104_1, out=buf171)
        del arg104_1
        buf172 = reinterpret_tensor(buf171, (4, 1024, 768), (786432, 768, 1), 0); del buf171  # reuse
        buf176 = reinterpret_tensor(buf167, (4, 1024, 768), (786432, 768, 1), 0); del buf167  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_47, hidden_states_49, hidden_states_50], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf172, arg103_1, buf152, buf159, arg97_1, arg105_1, arg106_1, buf176, 4096, 768, grid=grid(4096), stream=stream0)
        del arg103_1
        del arg105_1
        del arg106_1
        del arg97_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf176, (4096, 768), (768, 1), 0), arg108_1, out=buf177)
        del arg108_1
        buf178 = reinterpret_tensor(buf177, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf177  # reuse
        # Topologically Sorted Source Nodes: [mul_32, pow_9, mul_33, add_35, mul_34, tanh_8, add_36, hidden_states_51], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf178, arg107_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg107_1
        buf179 = reinterpret_tensor(buf176, (4096, 768), (768, 1), 0); del buf176  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf178, (4096, 3072), (3072, 1), 0), arg110_1, out=buf179)
        del arg110_1
        buf183 = reinterpret_tensor(buf159, (4, 1024, 768), (786432, 768, 1), 0); del buf159  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_53, hidden_states_54], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf172, buf179, arg109_1, arg111_1, arg112_1, buf183, 4096, 768, grid=grid(4096), stream=stream0)
        del arg111_1
        del arg112_1
        buf184 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_72], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg113_1, reinterpret_tensor(buf183, (4096, 768), (768, 1), 0), arg114_1, alpha=1, beta=1, out=buf184)
        del arg113_1
        del arg114_1
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf185, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output_36], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf186 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf184, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf184, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf184, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf185, False)
        buf187 = buf186[0]
        del buf186
        buf191 = reinterpret_tensor(buf183, (4096, 768), (768, 1), 0); del buf183  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf187, (4096, 768), (768, 1), 0), arg116_1, out=buf191)
        del arg116_1
        buf192 = reinterpret_tensor(buf191, (4, 1024, 768), (786432, 768, 1), 0); del buf191  # reuse
        buf196 = reinterpret_tensor(buf187, (4, 1024, 768), (786432, 768, 1), 0); del buf187  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_53, hidden_states_55, hidden_states_56], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf192, arg115_1, buf172, buf179, arg109_1, arg117_1, arg118_1, buf196, 4096, 768, grid=grid(4096), stream=stream0)
        del arg109_1
        del arg115_1
        del arg117_1
        del arg118_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf196, (4096, 768), (768, 1), 0), arg120_1, out=buf197)
        del arg120_1
        buf198 = reinterpret_tensor(buf197, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf197  # reuse
        # Topologically Sorted Source Nodes: [mul_36, pow_10, mul_37, add_39, mul_38, tanh_9, add_40, hidden_states_57], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf198, arg119_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg119_1
        buf199 = reinterpret_tensor(buf196, (4096, 768), (768, 1), 0); del buf196  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf198, (4096, 3072), (3072, 1), 0), arg122_1, out=buf199)
        del arg122_1
        buf203 = reinterpret_tensor(buf179, (4, 1024, 768), (786432, 768, 1), 0); del buf179  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_59, hidden_states_60], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf192, buf199, arg121_1, arg123_1, arg124_1, buf203, 4096, 768, grid=grid(4096), stream=stream0)
        del arg123_1
        del arg124_1
        buf204 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_80], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg125_1, reinterpret_tensor(buf203, (4096, 768), (768, 1), 0), arg126_1, alpha=1, beta=1, out=buf204)
        del arg125_1
        del arg126_1
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf205, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output_40], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf206 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf204, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf204, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf204, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf205, False)
        buf207 = buf206[0]
        del buf206
        buf211 = reinterpret_tensor(buf203, (4096, 768), (768, 1), 0); del buf203  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf207, (4096, 768), (768, 1), 0), arg128_1, out=buf211)
        del arg128_1
        buf212 = reinterpret_tensor(buf211, (4, 1024, 768), (786432, 768, 1), 0); del buf211  # reuse
        buf216 = reinterpret_tensor(buf207, (4, 1024, 768), (786432, 768, 1), 0); del buf207  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_59, hidden_states_61, hidden_states_62], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf212, arg127_1, buf192, buf199, arg121_1, arg129_1, arg130_1, buf216, 4096, 768, grid=grid(4096), stream=stream0)
        del arg121_1
        del arg127_1
        del arg129_1
        del arg130_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf216, (4096, 768), (768, 1), 0), arg132_1, out=buf217)
        del arg132_1
        buf218 = reinterpret_tensor(buf217, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf217  # reuse
        # Topologically Sorted Source Nodes: [mul_40, pow_11, mul_41, add_43, mul_42, tanh_10, add_44, hidden_states_63], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf218, arg131_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg131_1
        buf219 = reinterpret_tensor(buf216, (4096, 768), (768, 1), 0); del buf216  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf218, (4096, 3072), (3072, 1), 0), arg134_1, out=buf219)
        del arg134_1
        buf223 = reinterpret_tensor(buf199, (4, 1024, 768), (786432, 768, 1), 0); del buf199  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_65, hidden_states_66], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf212, buf219, arg133_1, arg135_1, arg136_1, buf223, 4096, 768, grid=grid(4096), stream=stream0)
        del arg135_1
        del arg136_1
        buf224 = empty_strided_cuda((4096, 2304), (2304, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x_88], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg137_1, reinterpret_tensor(buf223, (4096, 768), (768, 1), 0), arg138_1, alpha=1, beta=1, out=buf224)
        del arg137_1
        del arg138_1
        ...
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(buf225, 50331648, grid=grid(50331648), stream=stream0)
        # Topologically Sorted Source Nodes: [attn_output_44], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf226 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf224, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 0), reinterpret_tensor(buf224, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf224, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), buf225, False)
        del buf225
        buf227 = buf226[0]
        del buf226
        buf231 = reinterpret_tensor(buf223, (4096, 768), (768, 1), 0); del buf223  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf227, (4096, 768), (768, 1), 0), arg140_1, out=buf231)
        del arg140_1
        buf232 = reinterpret_tensor(buf231, (4, 1024, 768), (786432, 768, 1), 0); del buf231  # reuse
        buf236 = reinterpret_tensor(buf227, (4, 1024, 768), (786432, 768, 1), 0); del buf227  # reuse
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf232, arg139_1, buf212, buf219, arg133_1, arg141_1, arg142_1, buf236, 4096, 768, grid=grid(4096), stream=stream0)
        del arg133_1
        del arg139_1
        del arg141_1
        del arg142_1
        ...
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf236, (4096, 768), (768, 1), 0), arg144_1, out=buf237)
        del arg144_1
        buf238 = reinterpret_tensor(buf237, (4, 1024, 3072), (3145728, 3072, 1), 0); del buf237  # reuse
        # Topologically Sorted Source Nodes: [mul_44, pow_12, mul_45, add_47, mul_46, tanh_11, add_48, hidden_states_69], Original ATen: [aten.mul, aten.pow, aten.add, aten.tanh]
        triton_poi_fused_add_mul_pow_tanh_3.run(buf238, arg143_1, 12582912, grid=grid(12582912), stream=stream0)
        del arg143_1
        buf239 = reinterpret_tensor(buf236, (4096, 768), (768, 1), 0); del buf236  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf238, (4096, 3072), (3072, 1), 0), arg146_1, out=buf239)
        del arg146_1
        del buf238
        buf243 = reinterpret_tensor(buf219, (4, 1024, 768), (786432, 768, 1), 0); del buf219  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_71, layer_norm_24], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_4.run(buf232, buf239, arg145_1, arg147_1, arg148_1, buf243, 4096, 768, grid=grid(4096), stream=stream0)
        del arg145_1
        del arg147_1
        del arg148_1
        del buf232
        del buf239
        buf244 = empty_strided_cuda((4096, 2), (2, 1), torch.float32)
        # Topologically Sorted Source Nodes: [logits], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf243, (4096, 768), (768, 1), 0), reinterpret_tensor(arg149_1, (768, 2), (1, 768), 0), out=buf244)
        del arg149_1
        del buf243
        buf245 = empty_strided_cuda((4, ), (1, ), torch.int64)
        # Topologically Sorted Source Nodes: [eq, int_1, argmax], Original ATen: [aten.eq, aten._to_copy, aten.argmax]
        triton_per_fused__to_copy_argmax_eq_6.run(arg0_1, buf245, 4, 1024, grid=grid(4), stream=stream0)
        del arg0_1
        buf246 = empty_strided_cuda((4, 2), (2, 1), torch.float32)
        # Topologically Sorted Source Nodes: [pooled_logits], Original ATen: [aten.index]
        triton_poi_fused_index_7.run(buf245, buf244, buf246, 8, grid=grid(8), stream=stream0)
        del buf244
        del buf245
        buf247 = empty_strided_cuda((), (), torch.float32)
        buf249 = buf247; del buf247  # reuse
        # Topologically Sorted Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_8.run(buf249, arg150_1, buf246, 1, 4, grid=grid(1), stream=stream0)
        del arg150_1
    return (buf249, buf246, reinterpret_tensor(buf4, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf4, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf24, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf24, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf44, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf44, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf64, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf64, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf84, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf84, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf104, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf104, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf124, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf124, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf144, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf144, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf164, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf164, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf184, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf184, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf204, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf204, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), reinterpret_tensor(buf224, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 768), reinterpret_tensor(buf224, (4, 12, 1024, 64), (2359296, 64, 2304, 1), 1536), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg149_1 = rand_strided((2, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    arg150_1 = rand_strided((4, ), (1, ), device='cuda:0', dtype=torch.int64)
